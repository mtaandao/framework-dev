...
* [Support forum](http://mtaandao.org/support/plugin/shortcodes-ultimate/)
...
* Added: new attribute for [button title=""], [forum topic](https://mtaandao.org/support/topic/how-add-title-tag-to-a-button)
...
* Fixed: minor improvement for slider/gallery posts query. [Forum topic](https://mtaandao.org/support/topic/slider-code-suggestion)
...
* Fixed: errors when updating user profile, [forum topic](https://mtaandao.org/support/topic/error-message-when-updating-users-in-admin)
...
* Added: new option wmode for [youtube_advanced], [forum topic](http://mtaandao.org/support/topic/youtube-player-option-request)
* Added: new shortcode [lightbox_content]
* Fixed: lightbox and galleries scripts, [forum topic](http://mtaandao.org/support/topic/carousel-su-little-hack)
* Fixed: removed global function $.support.transition, [forum topic](http://mtaandao.org/support/topic/transition-check-returns-string-instead-of-object)
...
* Fixed: animations script has been changed. CSS animations will be skipped in non-supported browsers, [forum topic](http://mtaandao.org/support/topic/disable-animations-on-non-supported-devicesbrowsers)
* Fixed: templates/default-loop.php - removed extra n character in comments number, [forum topic](http://mtaandao.org/support/topic/minor-bug-in-templatesdefault-loopphp)
* Fixed: large DB query on sites with many users, [forum topic](http://mtaandao.org/support/topic/installing-sc-ultimate-on-site-with-30000-mn-users)
...
* Added: full compatibility with multiple editors on same page - [fourm topic](http://mtaandao.org/support/topic/enhance-compatibility-with-other-plugins)
* Fixed: extra CSS class for [menu] - [forum topic](http://mtaandao.org/support/topic/extra-css-class-not-working-on-menu-shortcode-video-included)
* Fixed: Swiper click event, Swiper has been updated - [forum topic](http://mtaandao.org/support/topic/carousel-links-not-working)
...
* Fixed bug with multiple users queries - [forum topic](http://mtaandao.org/support/topic/plugin-making-700-sql-calls)
...
* New locale - VI
* Fixed bug with tax_term IDs in [posts] shortcode, [forum topic](http://mtaandao.org/support/topic/posts-tax_term-category-number)
* Fixed bug with service title, [forum topic](http://mtaandao.org/support/topic/service-shortcode-not-wrapping-properly-on-mobile-browser)
* Fixed bug with animations names in shortcode generator, [forum topic](http://mtaandao.org/support/topic/animations-2)
...
* Compatibility with recent version of [Visual Composer](http://vc.mnbakery.com/)
...
* Anchor navigation for spoilers and tabs - [forum topic](http://mtaandao.org/support/topic/hyperlinks-to-spoilers-and-tabs)
* Small fixes
...
* Z-index for visual composer - [forum topic](http://mtaandao.org/support/topic/compatible-with-visual-composer)
...
* Fixed warning in footer - [forum topic](http://mtaandao.org/support/topic/bug-showing-in-online-site-after-updating-the-plugin)
* Removed warning at settings page - [forum topic](http://mtaandao.org/support/topic/warning-on-settings-page)
* Removed another warning (undefined index) - [forum topic](http://mtaandao.org/support/topic/undefined-index-with-mn_debug-true)
...
* Added new attribute. [tab disabled="yes"]. Now, any tab can be disabled. [Forum topic](http://mtaandao.org/support/topic/tabs-how-to-disable-one-of-the-tabs)
* Added [accordion] scrolling. [Forum topic](http://mtaandao.org/support/topic/accordion-usability-issue)
