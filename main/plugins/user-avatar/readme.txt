...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=marutimohanty89@gmail.com&item_name=MN%20Social%20Avatar
...
This plugin gives the users the option to use their social profile picture as the Mtaandao Avatar

== Description ==

As the name suggests, this plugin allows you to use the social profile picture as your Mtaandao Avatar.
You can see more, on how to install and use the plugin here in this blog [MN Social Avatar](http://www.sourcexpress.com/mn-social-avatar/)
...
**MN Social Avatar Settings:**

After activating the plugin admin will see **MN Avatar**, under Users menu. Here the admin can set the minimum role/capabilities required to avail this feature.
...
== Installation ==
1. Upload "**mn-social-avatar**" folder to the "main/**plugins**" directory.
...
= 1.4.1 =
* Introduced mn_social_avatar_heading filter
...
= 1.2 =
* Now Users can either use the Google plus user id or the new Google Plus handle for MN Social Avatar Google Plus option. 
