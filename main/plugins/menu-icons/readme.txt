...
= Extensions =
- [IcoMoon](http://mtaandao.org/plugins/menu-icons-icomoon/) by [IcoMoon.io](http://icomoon.io/)
...
If you have [Jetpack](http://mtaandao.org/plugins/jetpack) installed, you can also use its **Custom CSS** module.
Otherwise, I recommend you to use the [Simple Custom CSS plugin](http://mtaandao.org/plugins/simple-custom-css/).
...
Add this block of code to your [mu-plugin file](http://codex.mtaandao.org/Must_Use_Plugins):
`
...
== Changelog ==
= 0.10.1 =
* Support RTL, props [ybspost](https://mtaandao.org/support/profile/ybspost).
...
= 0.8.1 =
* Fix disappearing icons from front-end when not logged-in, props [jj9617](http://profiles.mtaandao.org/jj9617/)
...
* Add missing Foundation Icons stylesheet, props [John](http://mtaandao.org/support/profile/dsl225)
* JS & CSS fixes
...
= 0.3.2 =
* Add missing minified CSS for Elusive font icon, props [zazou83](http://profiles.mtaandao.org/zazou83)

= 0.3.1 =
* Fix fatal error on outdated PHP versions, props [dellos](http://profiles.mtaandao.org/dellos)
