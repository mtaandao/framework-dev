...
Types.page.fieldControl.Class = function ($) {
    ...
    self.init = function () {
        ...
        var modelData = $.parseJSON(MNV_Toolset.Utils.editor_decode64($('#types_model_data').html()));
    ...
    /**
     * Initialize the dialog handler for displaying standard Custom Content dialogs.
     * 
     * @since 2.0
     */
