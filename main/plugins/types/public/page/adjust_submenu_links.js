...
(function($) {
    ...
    /**
     * Utility for adding URL parameters to Mtaandao admin menus, which is currently not supported by Mtaandao.
     * 
     * Usage: 
     ...
     *  
     * If the params object is provided via mn_localize_script in Types.l10n.paramsToAddToSubmenu, it will be applied
    ...
    Types.page.menuLinkAdjuster = new function() {
        ...
        self.currentSubmenuSelector = '.mn-has-current-submenu li.current a';
