...
<div class="otgs_mn_installer_table otgs_mn_installer_table_compact">
...
<?php if(!$this->repository_has_subscription($repository_id) || !empty($subscription_no_match)): ?>
            ...
            <div>
                ...
                <a class="enter_site_key_js<?php if( MN_Installer::get_repository_hardcoded_site_key( $repository_id ) ): ?> disabled<?php endif ?>" href="#"
...
if( isset( $args[ 'name' ] ) ):
    ...
    <?php if($support_link): ?>
<p><a href="<?php echo $support_link ?>" target="_blank"><?php printf(__('%s support on mnml.org', 'installer'), $args['name'] ) ?></a></p>
