...
?>
<table class="widefat otgs_mn_installer_table" id="installer_repo_<?php echo $repository_id ?>">
    ...
    <tr>
        ...
        <td class="otgsi_register_product_wrap" align="center" valign="top">
            ...
            <div style="text-align: right;">
                ...
                <a class="enter_site_key_js button-primary<?php if( MN_Installer::get_repository_hardcoded_site_key( $repository_id ) ): ?> disabled<?php endif ?>" href="#"
                    <?php if( MN_Installer::get_repository_hardcoded_site_key( $repository_id ) ): ?>
                        style="cursor: help"
                        disabled="disabled"
                        title="<?php printf( esc_attr__("Site-key was set by %s, most likely in mn-config.php. Please remove the constant before attempting to register.", 'installer'), 'OTGS_INSTALLER_SITE_KEY_' . strtoupper($repository_id) ) ?>"
                    <?php endif; ?>
                >
                ...
                <input type="hidden" name="nonce" value="<?php echo mn_create_nonce('save_site_key_' . $repository_id) ?>" />
                ...
                <div>
                    <p class="installer-warn-box">
                        ...
                        <span class="alignright">
                            <a class="update_site_key_js button-secondary" href="#" data-repository=<?php echo $repository_id ?> data-nonce="<?php echo mn_create_nonce('update_site_key_' . $repository_id) ?>">
            ...
            <div class="alignright">
                <a class="remove_site_key_js button-secondary" href="#" data-repository=<?php echo $repository_id ?>
                    ...
                    data-nonce="<?php echo mn_create_nonce('remove_site_key_' . $repository_id) ?>"
                    <?php if( MN_Installer::get_repository_hardcoded_site_key( $repository_id ) ): ?>
                     style="cursor: help"
                     disabled="disabled"
                     title="<?php printf( esc_attr__("Site-key was set by %s, most likely in mn-config.php. Please remove the constant before attempting to unregister.", 'installer'), 'OTGS_INSTALLER_SITE_KEY_' . strtoupper($repository_id) ) ?>"
                    <?php endif; ?>
                    >
                ...
                <a class="update_site_key_js button-secondary" href="#" data-repository=<?php echo $repository_id ?>
                    data-nonce="<?php echo mn_create_nonce('update_site_key_' . $repository_id) ?>">
    ...
    <tr id="repository-<?php echo $repository_id ?>_<?php echo $package['id'] ?>">
        ...
        <td>
            ...
            <?php if(!empty($package['sub-packages'])): ?>
                ...
                <table class="otgs_mn_installer_subtable" style="<?php if($subpackages_expandable) echo 'display:none' ?>">
