                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        $disabled = $expired ||
                                                    ...
                                                    ) || MN_Installer()->dependencies->cant_download( $repository_id );
                    ...
                    <?php if( !MN_Installer()->dependencies->is_uploading_allowed() ): ?>
                        <p class="installer-error-box"><?php printf(__('Downloading is not possible because Mtaandao cannot write into the plugins folder. %sHow to fix%s.', 'installer'),
