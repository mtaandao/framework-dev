...
class Toolset_User_Editors_Editor_Screen_Visual_Composer_Backend
	...
	public function htmlOutput() {
		...
		<div style="display: none;">
			...
			<textarea cols="30" rows="10" id="mnv_content" name="mnv_content" data-bind="textInput: postContentAccepted"></textarea>
			<?php mn_editor(  $this->post->post_content, 'content', array( 'media_buttons' => true ) ); ?>
		</div>

		<div id="mnb_visual_composer" style="padding-bottom: 5px; background: #fff;"><?php $this->editor->renderEditor( $this->post ); ?></div>
		<?php
		$script = "<script>
				jQuery( window ).load( function( ) {
					...
					var viewsBasicTextarea 		 = jQuery( '#mnv_content' );
					var mtaandaoDefaultTextarea = jQuery( '#content' );
					...
					vc.shortcodes.on( 'sync', function() {
						if( mtaandaoDefaultTextarea.val() != viewsBasicTextarea.val() ) {
							viewsBasicTextarea.val( mtaandaoDefaultTextarea.val() );

							MNViews.ct_edit_screen.vm.postContentAccepted = function(){ return mtaandaoDefaultTextarea.val() };
							MNViews.ct_edit_screen.vm.propertyChangeByComparator( 'postContent', _.isEqual );
						}
					} );
				} );</script>";
	...
	public function print_scripts() {
		...
		<style type="text/css">
			...
			body.toolset_page_ct-editor .mnv-settings-section,
			body.toolset_page_ct-editor .mnv-setting-container {
				max-width: 96% !important;
			}
			
			body.toolset_page_ct-editor .mnv-setting-container .mnv-settings-header {
				width: 15% !important;
			}
			...
			.mnv-mightlong-list li {
				min-width: 21%;
			}

			body.toolset_page_ct-editor .js-mnv-content-section .mnv-settings-header {
				display: block;
			}
			
			body.toolset_page_ct-editor .mnv-ct-control-switch-editor {
				padding-left: 105px;
			}
			
			body.toolset_page_ct-editor .js-mnv-content-section .mnv-setting {
				width: 100% !important;
			}
