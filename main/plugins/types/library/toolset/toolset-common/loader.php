...
/**
*
* This file is responsible for loading the latest version of the Custom Content Common lbraries.
*
...
* where XXX is the future target Custom Content Common version number, built upon the stable released one stated in changelog.txt plus 1
* and YYY is incremented by 1 on each change to the Custom Content Common repo
