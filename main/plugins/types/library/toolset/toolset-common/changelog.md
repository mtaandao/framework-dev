...
- Added an internal Custom Content compatibility class

## 2.2.1 (August 25, 2016)
 
- Avoid translating the Custom Content top level admin menu label
	
## 2.2 (August 24, 2016)

- Added compatibility classes for Relevanssi and Beaver Builder
- Added a CSS components class
- Improved the Custom Content Common assets management
...
- Improved compatibility with MNML, including admin language switchers and loading times
...
- Added Custom Content Dialog Boxes to provide a unified way to create and render dialogs
- Fixed various bugs
...
- Fixed empty title problem for filter "mnt_field_options" on user edit/add screen.
https://mn-types.com/forums/topic/populate-select-field-in-mncf-um-group/
- Added filter "toolset_editor_add_form_buttons" to disable Custom Content buttons on the post editor.
