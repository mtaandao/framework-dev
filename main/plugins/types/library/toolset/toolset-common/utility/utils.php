<?php
if (defined('MNT_UTILS')) {
    return;
}

define('MNT_UTILS', true);
...
if (!class_exists('Toolset_Utils')) {
     ...
     * ToolsetUtils
     *
     * A collection of static methods to be used across Custom Content plugins
     *
     * @since 1.7
     */
    class Toolset_Utils {
         ...
         * help_box
         *
         * Creates the HTML version for the mnvToolsetHelp() javascript function
         *
...
if (!function_exists('mn_json_encode')) {
    ...
    if (!function_exists('_mn_json_sanity_check')) {
    ...
    if (!function_exists('_mn_json_convert_string')) {
 ...
 * This function is needed by MNDDL_Theme_Integration_Abstract.
 */
