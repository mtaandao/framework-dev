...
if ( ! class_exists( 'Toolset_DialogBoxes' ) ) {
	class Toolset_DialogBoxes
	{
		...
		function register_scripts( $scripts ) {
			$scripts['ddl-abstract-dialog']	= new Toolset_Script( 'ddl-abstract-dialog', TOOLSET_COMMON_URL . '/utility/dialogs/js/views/abstract/ddl-abstract-dialog.js', array('jquery','mndialogs'), '0.1', false );
                ...
                <div id="js-dialog-dialog-container">
                    <div class="ddl-dialog-content" id="js-dialog-content-dialog">
                        <?php printf(
                            ...
                            '<p>',
                            '<br><a href="https://mn-types.com/documentation/user-guides/enable-pop-ups-browser/?utm_source=layoutsplugin&utm_campaign=layouts&utm_medium=enable-pop-ups-browser&utm_term=help-link" title="enable popups" target="_blank">',
                            '</a></p>'
                        );
                        ?>
                        <p>
