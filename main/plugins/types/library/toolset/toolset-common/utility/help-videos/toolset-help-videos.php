...
if( !class_exists('Toolset_HelpVideo') ) {
    ...
    class Toolset_HelpVideo extends stdClass
    {
        ...
        {
            $scripts['toolset-help-video'] = new Toolset_Script('toolset-help-video', TOOLSET_COMMON_URL . '/utility/help-videos/res/js/toolset-help-videos.js', array('jquery', 'underscore', 'backbone', 'mn-mediaelement', 'toolset-utils'), '1.0', true);
            return $scripts;
        }
        ...
        public function admin_enqueue_scripts()
        {
            ...
            do_action('toolset_localize_script', 'toolset-help-video', 'MN_ToolsetVideoSettings', array(
