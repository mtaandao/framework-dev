    ...
    class Toolset_CakePHP_Validation {
        ...
        function comparison($check1, $operator = null, $check2 = null) {
            ...
            switch ($operator) {
                ...
                default:
                    $_this = & Toolset_CakePHP_Validation::getInstance();
                    $_this->errors[] = __('You must define the $operator parameter for Toolset_CakePHP_Validation::comparison()', 'mncf');
                    break;
            }
            return false;
        }
        ...
        function custom($check, $regex = null) {
            ...
            if ($_this->regex === null) {
                $_this->errors[] = __('You must define a regular expression for Toolset_CakePHP_Validation::custom()', 'mncf');
                return false;
            }
            return $_this->_check();
        }
