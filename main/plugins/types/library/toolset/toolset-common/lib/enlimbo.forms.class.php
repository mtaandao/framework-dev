...
if ( ! class_exists('Toolset_Enlimbo_Forms' ) ) {
    ...
    class Toolset_Enlimbo_Forms
    {
        ...
        public function autoHandle($id, $form)
        {
            ...
            if ($this->isSubmitted()) {
                ...
                if (empty($this->_errors)) {
                    ...
                    if (empty($this->_errors)) {
                        // redirect
                        do_action('mncf_form_autohandle_redirection', $id,
                                $form, $this);
                        do_action('mncf_form_autohandle_redirection_' . $id,
                                $form, $this);
        ...
        public function isSubmitted($id = '')
        {
            ...
            return (isset($_REQUEST['_mnnonce_mncf'])
        ...
        private function _setElementAttributes($element)
        {
            ...
            if (!isset($element['#attributes']['class'])) {
				$is_default_element = isset( $element['#default_value'] ) && $element['#default_value'] ? ' mncf-default-value-input' : '';
