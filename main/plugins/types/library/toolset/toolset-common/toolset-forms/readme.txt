...
$html = mntoolset_form_field( $field_db_data );

To get HTML and rest of the scripts queued,
call function before queue_styles MN hook.
...
- Fixed empty object in MNV_Handle_Users_Functions class when user is
...
- Fixed a problem with missing taxonomies after form fail:
  https://mn-types.com/forums/topic/cred-featured-image-and-tag-selector-empty-after-validation-refresh/

2014-11-10

- Fixed a problem with datepicker witch do not working inside a modal
  dialog
  https://mn-types.com/forums/topic/cred-forms-not-displaying-on-tabletmobile-browsers/
...
- add filters to change repetitive buttons text:
  ...
  https://mn-types.com/forums/topic/format-form-field-as-list/#post-255070
  https://mn-types.com/forums/topic/hi/
  https://mn-types.com/forums/topic/how-to-change-mnt-repdelete-button-value/

2014-10-23
- Fixed issue with missing previously saved data.
  https://mn-types.com/forums/topic/date-not-recorded-in-a-postype
...
- Fixed a problem with WYSIWYG field description.
  https://mn-types.com/forums/topic/add-a-link-in-the-custom-field-description/
...
- Fixed issue on checkbox after submit - there was wrong condition to
  ...
  https://mn-types.com/forums/topic/checkbox-value-not-saved/
...
- Fixed a wrong error message position, was under date field.
  https://mn-types.com/forums/topic/some-issues-and-feedback-on-cred-1-3-3/
...
- Improved - add class for li element for checkboxes, radio, taxonomy
  ...
  http://mn-types.com/forums/topic/ugly-cred-taxonomy-cannot-style/
...
- Fixed warning on user site, when CRED is not installed and we check
  ...
  https://mn-types.com/forums/topic/i-just-updated-types-and-im-getting-this-error/

- Fixed problem with validation if is empty conditions, validation
  should return true, not false.
  https://mn-types.com/forums/topic/custom-types-fields-not-saving-changes/
...
- Fixed problem with replacing @ char from filename
  https://mn-types.com/forums/topic/types-sanitizes-sign-from-file-names/

2014-10-03

- Fixed a problem with abandon filter mncf_fields_*_value_get - this
  ...
  http://mn-types.com/forums/topic/default-field-value-custom-function-no-longer-works/
...
- Fixed changing the file name when upload the file
  ...
  http://mn-types.com/forums/topic/types-1-6-update-breaks-layout-that-worked-in-types-1-5-7/
...
- Fixed a problem with multiple CRED form on one screen.
  ...
  http://mn-types.com/forums/topic/cred-conditional-group-3/
