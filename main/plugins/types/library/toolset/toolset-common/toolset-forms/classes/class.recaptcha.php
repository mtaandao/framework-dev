...
class MNToolset_Field_Recaptcha extends MNToolset_Field_Textfield {
    ...
    public function init() {
        ...
        //mn_register_script('mnt-cred-recaptcha', MNTOOLSET_FORMS_RELPATH . '/js/recaptcha-v2/api.js', array('mntoolset-forms'), MNTOOLSET_FORMS_VERSION, true);
        //mn_register_script('mnt-cred-recaptcha', MNTOOLSET_FORMS_RELPATH . '/js/recaptcha-v2/api.js', array('mntoolset-forms'), MNTOOLSET_FORMS_VERSION, true);
        mn_enqueue_script('mnt-cred-recaptcha', '//www.google.com/recaptcha/api.js?hl=' . $lang);
    }
    ...
    public function metaform() {
        ...
        if ($this->pubkey || !is_admin()) {
            try {
                $capture = '<div class="g-recaptcha" data-sitekey="' . $this->pubkey . '"></div><div class="recaptcha_error" style="color:#aa0000;display:none;">' . __('Please validate reCAPTCHA', 'mnv-views') . '</div>';
            } catch (Exception $e) {
