...
class MNToolset_Field_Checkboxes extends FieldFactory
{
    public function metaform()
    {
        ...
        if ( is_admin() ) {
            ...
            $metaform['#after'] = '<input type="hidden" name="_mntoolset_checkbox[' . $this->getId() . ']" value="1" />';
        } else {
			$metaform['#before'] = '<ul class="mnt-form-set mnt-form-set-checkboxes mnt-form-set-checkboxes-' . $name . '">';
			$metaform['#after'] = '</ul>';
		}
