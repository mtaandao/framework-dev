...
/**
* Generator of debug unformation for the Custom Content family.
*
...
?>
<div class="wrap">
	<h1><?php _e('Custom Content Debug Information', 'mnv-views');?></h1>
	<div class="inside">
		<p><?php _e( 'This information allows our support team to see the versions of Mtaandao, plugins and theme on your site. Provide this information if requested in our support forum. No passwords or other confidential information is included.', 'sitepress', 'mnv-views' ) ?></p><br/>
