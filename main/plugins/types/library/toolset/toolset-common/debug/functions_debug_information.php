...
if ( ! class_exists( 'ICL_Debug_Information' ) ) {
	class ICL_Debug_Information
	{
		...
		function get_core_info() {
			...
			$jquery_ver = __( 'n/a', 'mnv-views' );
			if ( mn_script_is( 'jquery', 'registered' ) ) {
				$reg_scripts = $GLOBALS['mn_scripts']->registered;
