 ...
 *
 * Common localization for shared code on the Custom Content and also common way for adding textdomains
 *
 * @since unknown
 */
...
if ( ! class_exists( 'Toolset_Localization' ) ) {
	 ...
	 *
	 * Methods for registering textdomains, defaults to register the mnv-views one.
	 *
	 * @since unknown
	 */
	class Toolset_Localization {
		 ...
		 */
		function __construct( $textdomain = 'mnv-views', $path = TOOLSET_LOCALIZATION_ABSPATH , $mo_name = 'views-%s' ) {
