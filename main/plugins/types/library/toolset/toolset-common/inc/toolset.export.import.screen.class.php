...
if ( ! defined( 'MNT_EXPORT_IMPORT_SCREEN' ) ) {
    define( 'MNT_EXPORT_IMPORT_SCREEN', true );
}

/**
* Toolset_Export_Import_Screen
*
* Generic class for the shared export / import entry for the Custom Content family.
*
* @since 1.9
*/
    ...
    class Toolset_Export_Import_Screen {
		...
		public function register_export_import_page_in_menu( $pages ) {
			$pages[] = array(
				...
				'menu_title'	=> __( 'Export / Import', 'mnv-views' ),
				'page_title'	=> __( 'Export / Import', 'mnv-views' ),
		...
		*/
		...
		public function export_import_page() {
			...
			* 20: Custom Content Views
			* 30: Custom Content Layouts
			* 40: Custom Content CRED
			* 50: Custom Content Access
			*/
			...
			?>
			<div class="wrap">
				<h1><?php echo esc_html( __( 'Custom Content Export / Import', 'mnv-views' ) ); ?></h1>
				<?php
				$export_import_menu = '';
