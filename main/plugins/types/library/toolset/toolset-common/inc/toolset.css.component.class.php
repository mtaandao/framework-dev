...
if ( ! class_exists( 'Toolset_CssComponent' ) ) {
    ...
    Class Toolset_CssComponent{
        ...
        function __construct() {
            ...
            add_action( 'mn_ajax_toolset_bs_update_option', array($this, 'toolset_bs_update_option') );
        }
        ...
        public function is_allowed_page(){
            ...
            $bootstrap_version_option = get_option( 'mnv_options' );
            
            if(isset($bootstrap_version_option["mnv_bootstrap_version"]) && $bootstrap_version_option["mnv_bootstrap_version"] != "-1"){
        ...
        function load_dialog_boxes(){
            ...
            $dialogs = array();
            $dialogs[] = new MNDDL_CssComponenetDialog( array('toolset_page_views-editor','toolset_page_dd_layouts_edit','toolset_page_view-archives-editor','toolset_page_ct-editor') );
    ...
    class MNDDL_CssComponenetDialog extends Toolset_DialogBoxes{
                        ...
                        <div id="components-dialog-content">
                            ...
                            <div class="toolset-bs-components-dialog-sides">
                                ...
                                <div class="toolset-bs-components-dialog-sides-bottom">
                                    <hr>
                                    <p class="toolset-bs-button-p">
                                        <a href="<?php _e('https://mn-types.com/user-guides/using-bootstrap-css-elements-content?utm_source=layoutsplugin&utm_campaign=layouts&utm_medium=bootstrap-components&utm_term=help-link','ddl-layouts');?>" target="_blank"><?php _e('Learn how to use Bootstrap in layouts','ddl-layouts');?></a>
                                    </p>
                                </div>
                            </div>
