...
if ( ! defined( 'MNT_PROMOTION' ) ) {
    define( 'MNT_PROMOTION', true );
}

/**
* Toolset_Promotion
*
* As of now, displays promotional messages on embedded versions of Custom Content plugins.
*
* @since unknown
*/
...
if ( ! class_exists( 'Toolset_Promotion' ) ) {
    ...
    class Toolset_Promotion
    {
        ...
        public function admin_enqueue_scripts() {
            ...
            mn_enqueue_style( 'toolset-promotion' );
            mn_enqueue_script( 'toolset-promotion' );
        }
        ...
        public function admin_footer() {
			...
			$link_learn =	$this->get_affiliate_promotional_link( 'http://mn-types.com/' );
			$link_button =	$this->get_affiliate_promotional_link( 'http://mn-types.com/', $link_button_args );
            ...
            <script type="text/html" id="js-buy-toolset-embedded-message">
                <div class="toolset-modal">
                    <h2><?php _e('Want to edit Views, CRED forms and Layouts? Get the full <em>Toolset</em> package!', 'mncf'); ?></h2>

                    <div class="content">
                        <p class="full"><?php _e('The full <em>Toolset</em> package allows you to develop and customize themes without touching PHP. You will be able to:', 'mncf'); ?></p>

                        <div class="icons">
                            <ul>
                                <li class="template"><?php _e('Create templates', 'mncf'); ?></li>
                                <li class="layout"><?php _e('Design page layouts using drag-and-drop', 'mncf'); ?></li>
                                <li class="toolset-search"><?php _e('Build custom searches', 'mncf'); ?></li>
                            </ul>
                            <ul>
                                <li class="list"><?php _e('Display lists of content', 'mncf'); ?></li>
                                <li class="form"><?php _e('Create front-end content editing forms', 'mncf'); ?></li>
                                <li class="more"><?php _e('and more…', 'mncf'); ?></li>
                            </ul>
                        </div>

                        <p class="description"><?php _e('Once you buy the full Toolset, you will be able to edit Views, CRED forms and Layouts in your site, as well as build new ones.', 'mncf'); ?></p>

                        <a href="<?php echo $link_button; ?>"
                           class="button"><?php _e('<em>Toolset</em> Package Options', 'mncf'); ?></a>
                        <a href="<?php echo $link_learn; ?>"
                           class="learn"><?php _e('Learn more about <em>Toolset</em>', 'mncf'); ?></a>
		...
		*/
		...
		private function get_affiliate_promotional_link( $url, $args = array() ) {
            ...
            $info = installer_ep_get_configuration( mn_get_theme()->Name );
