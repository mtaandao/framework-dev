...
class OnTheGoSystemsStyles_Class{
    ...
    {
        if ( is_admin() || defined('MNDDL_VERSION') ) {
            mn_register_style('onthego-admin-styles', ON_THE_GO_SYSTEMS_BRANDING_REL_PATH .'onthego-styles/onthego-styles.css');
            mn_enqueue_style( 'onthego-admin-styles' );
        }
    }
