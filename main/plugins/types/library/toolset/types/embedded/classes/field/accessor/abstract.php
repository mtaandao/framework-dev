 ...
 */
abstract class MNCF_Field_Accessor_Abstract {
	...
	/**
	 * MNCF_Field_Accessor_Abstract constructor.
	 *
	 ...
	 *
	 * @link https://developer.mtaandao.org/reference/functions/add_term_meta/
	 *
	 * @param mixed $value New value to be saved to the database
	 * @return mixed
	 */
