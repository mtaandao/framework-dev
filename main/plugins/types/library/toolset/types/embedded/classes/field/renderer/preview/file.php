 ...
 * @since 1.9.1
 */
final class MNCF_Field_Renderer_Preview_File extends MNCF_Field_Renderer_Preview_URL {
	...
	protected function get_link_label( $url_components ) {
		...
		$file_name = sanitize_text_field( basename( mncf_getarr( $url_components, 'path' ) ) );
