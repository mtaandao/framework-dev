...
class MNCF_Usermeta_Repeater extends MNCF_Usermeta_Field
{
    ...
    function _get_meta() {
        ...
        $cached_object_userfield = mn_cache_get( $cache_key_userfield, $cache_group );

        if ( $this->use_cache ) {
			if ( false != $cached_object_userfield && is_array( $cached_object_userfield ) ) {// Mtaandao cache
