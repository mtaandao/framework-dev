 ...
 * @since 1.9
 */
class MNCF_Field_Renderer_Toolset_Forms extends MNCF_Field_Renderer_Abstract {
	...
	public function setup( $args = array() ) {
		...
		$this->form_id = mncf_getarr( $args, 'form_id', $this->form_id );

		$this->hide_field_title = (bool) mncf_getarr( $args, 'hide_field_title', $this->hide_field_title );
	}
	...
	public function render( $echo = false ) {
		...
		$output = mntoolset_form_field( $this->get_form_id(), $field_config, $value_in_intermediate_format );
	...
	protected function get_toolset_forms_config() {
		...
		return mntoolset_form_filter_types_field( $this->field->get_definition()->get_definition_array(), $this->field->get_object_id() );
	}
