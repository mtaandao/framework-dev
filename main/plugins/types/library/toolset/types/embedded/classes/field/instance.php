 ...
 * @since 1.9
 */
abstract class MNCF_Field_Instance extends MNCF_Field_Instance_Unsaved {

	private $object_id;

	/**
	 * MNCF_Field_Instance constructor.
	 *
	 * @param MNCF_Field_Definition $definition Field definition.
	...
	protected function get_sort_order() {
		...
		return mncf_ensarr( $accessor->get_raw_value() );
	}
