...
class MNCF_Field_DataMapper_Checkboxes extends MNCF_Field_DataMapper_Abstract {
	...
	/**
	 * @param MNCF_Field_Definition $field_definition Must be a definition of a checkboxes field.
	 */
