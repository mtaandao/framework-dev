 ...
 * @since 1.9.1
 */
abstract class MNCF_Field_Renderer_Preview_Base extends MNCF_Field_Renderer_Abstract {
	...
	/**
	 * MNCF_Field_Renderer_Preview_Base constructor.
	 *
	...
	protected function get_value_separator() {
		return mncf_getarr( $this->args, 'value_separator', ', ' );
	}
	...
	protected function get_maximum_item_count() {
		return absint( mncf_getarr( $this->args, 'maximum_item_count' ) );
	}
	...
	protected function get_maximum_item_length() {
		return absint( mncf_getarr( $this->args, 'maximum_item_length' ) );
	}
	...
	protected function get_maximum_total_length() {
		return absint( mncf_getarr( $this->args, 'maximum_total_length' ) );
	}
	...
	protected function get_ellipsis() {
		return mncf_getarr( $this->args, 'ellipsis', '...' );
	}
