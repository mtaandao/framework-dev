 ...
 */
class MNCF_Conditional extends MNCF_Field
{
     ...
     * @var type 
     */
    var $css_class_trigger = 'mncf-conditional-check-trigger';

    /**
     * Field CSS class.
     * @var type 
     */
    var $css_class_field = 'mncf-conditional';
     ...
     */
    function evaluate() {
        MNCF_Loader::loadClass( 'evaluate' );
        $this->passed = MNCF_Evaluate::evaluate( $this );
        return $this->passed;
    }
