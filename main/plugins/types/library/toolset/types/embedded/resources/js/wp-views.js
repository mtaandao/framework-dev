/*
 * Custom Content Views plugin.
 *
 * Loaded on Views or Views Template edit screens.
 */
var typesMNViews = (function(window, $){
    ...
    function openFrameForWizard( fieldID, metaType, postID, shortcode ) {
        ...
        var url = ajaxurl+'?action=mncf_ajax&mncf_action=editor_callback'
        + '&_typesnonce=' + types.mnnonce
    ...
    return {
        ...
        wizardSendShortcode: function( shortcode ) {
            window.mnv_restore_wizard_popup(shortcode);
        },
        ...
        wizardCancel: function() {
            window.mnv_cancel_wizard_popup();
        }
    };
