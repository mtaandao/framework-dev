...
var MNCF_Script = MNCF_Script || {};

MNCF_Script.Modal_Script = function( $ ) {
    ...
    $( document ).on( 'js-mncf-event-types-show-modal', function( event ) {
        /*
         if ( $(this).hasClass('js-types-do-not-show-modal')) {
         return;
         }
...
jQuery( document ).ready( function( $ ) {
    MNCF_Script.mncf_modal_script = new MNCF_Script.Modal_Script( $ );
});
