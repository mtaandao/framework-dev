 ...
 * @global type $mncf
 */
function mncf_debug( $plain = false ) {
    if ( MNCF_DEBUG ) {
        global $mncf, $types_instances;
        $clone = clone $mncf;
...
<div onclick="jQuery(this).next().slideToggle();" style="cursor:pointer;padding: 10px 0px;"><strong><em>MN Query</em></strong></div><div style="display:none;"><br /><br /><pre>';
        global $mn_query;
        print_r( $mn_query );
        echo '</pre></div>';
...
<div onclick="jQuery(this).next().slideToggle();" style="cursor:pointer;padding: 10px 0px;"><strong><em>MN User</em></strong></div><div style="display:none;"><br /><br /><pre>';
        print_r( mn_get_current_user() );
        echo '</pre></div>';
