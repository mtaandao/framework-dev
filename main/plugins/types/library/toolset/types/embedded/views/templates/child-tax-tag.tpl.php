...
$html_id = esc_attr(mncf_unique_id( $tax_name ));
?>
<div class="js-types-child-tagsdiv" id="<?php echo $html_id; ?>">
	<div class="jaxtag">
	<div class="nojs-tags hide-if-js">
	<p><?php echo $taxonomy->labels->add_or_remove_items; ?></p>
	<textarea name="<?php echo esc_attr($_mncf_name); ?>" rows="3" cols="20" class="the-tags" id="tax-input-<?php echo $html_id; ?>" <?php disabled( ! $user_can_assign_terms ); ?>><?php echo str_replace( ',', $comma . ' ', get_terms_to_edit( $post->ID, $tax_name ) ); // textarea_escaped by esc_attr() ?></textarea></div>
    ...
    <div class="ajaxtag hide-if-no-js">
		...
		<input type="button" class="button js-types-addtag" value="<?php esc_attr_e('Add', 'mncf'); ?>" /></p>
	</div>
