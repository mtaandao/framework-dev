...
<div class="fieldset">
	<ul class="form-inline">
		<li>
			...
			<label for="radio-display-db"><?php _e( 'Display the value of this field from the database', 'mncf' ); ?></label>
		</li>
		<li>
			<input id="radio-display-val" type="radio" name="display" value="value" data-bind="checked: radio_mode" />
			<label for="radio-display-val"><?php _e( 'Show one of these values:', 'mncf' ); ?></label>
