...
<div class="fieldset form-inline">
	<ul>
		<li>
			...
			<label for="date-calendar"><?php _e( 'Show as calendar ', 'mncf' ); ?></label>
		</li>
		<li>
			<input id="date-text" type="radio" name="style" value="text" data-bind="checked: date_mode, click: dateStyling" />
			<label for="date-text"><?php _e( 'Show as text', 'mncf' ); ?></label>
				...
				<ul>
					...
					<?php endforeach; ?>
						...
						<li>
							...
							<label for="date-custom"><?php _e( 'Custom', 'mncf' ); ?></label>
							<input id="date-custom-format" type="text" name="custom" value="<?php echo $data['custom']; ?>" />
							<p>
								<a href="http://codex.mtaandao.org/Formatting_Date_and_Time" target="_blank"><i class="fa fa-book icon-book"></i><?php _e( 'Documentation on date and time formatting', 'mncf' ); ?></a>
							</p>
						</li>
				</ul>
			</div>
