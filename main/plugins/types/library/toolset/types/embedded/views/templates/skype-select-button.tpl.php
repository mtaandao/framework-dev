...
?>
<h3><?php _e( 'Select a button from below', 'mncf' ); ?></h3>
...
<h3><?php _e( 'Skype buttons with status', 'mncf' ); ?></h3>  
<p><?php _e( 'If you choose to show your Skype status, your Skype button will always reflect your availability on Skype. This status will be shown to everyone, whether they’re in your contact list or not.', 'mncf' ); ?></p>
