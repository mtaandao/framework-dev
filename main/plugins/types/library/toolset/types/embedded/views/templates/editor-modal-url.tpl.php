...
<div class="fieldset">
	<label class="input-title" for="url-title"><?php _e( 'Title', 'mncf' ); ?></label>
	<input id="url-title" type="text" name="title" value="<?php echo $data['title']; ?>" />
	<span class="help-text"><?php _e( 'If set, this text will be displayed instead of raw data', 'mncf' ); ?></span>
</div>

<div class="fieldset">
    <label class="input-title" for="url-protocol"><?php _e( 'No protocol', 'mncf' ); ?></label>
	<input id="url-protocol" type="checkbox" name="no_protocol" value="1"<?php if ( $data['no_protocol'] ) echo ' checked="checked"'; ?> />
	<span class="help-text"><?php _e( 'If checked, link will be rendered without http or https', 'mncf' ); ?></span>
</div>
...
<ul class="form-inline">
	...
	<div class="group-nested" data-bind="visible: url_target() == 'framename'">
	    <label for="url-target-framename"><?php _e( 'Enter framename', 'mncf' ); ?></label>
