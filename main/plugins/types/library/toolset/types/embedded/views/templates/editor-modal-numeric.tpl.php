...
<div class="fieldset">
	<p>
		<label for="numeric-format" class="input-title"><?php _e( 'Output format', 'mncf' ); ?></label>
		<input id="numeric-format" type="text" name="format" value="<?php echo $data['format']; ?>" />
	</p>
	<p>
		<?php _e( "Use FIELD_NAME for title and FIELD_VALUE for value", 'mncf' ); ?>
        <br />
        <?php _e( "e.g. Value of FIELD_NAME is FIELD_VALUE", 'mncf' ); ?>
	</p>
</div>
