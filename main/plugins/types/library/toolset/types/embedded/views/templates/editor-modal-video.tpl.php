...
<div class="fieldset">
    <p>
        <label for="video-width" class="input-title"><?php _e( 'Width', 'mncf' ); ?></label>
        <input id="video-width" type="text" name="width" value="<?php echo $data['width']; ?>" />
    </p>
    <p>
        <label for="video-height" class="input-title"><?php _e( 'Height', 'mncf' ); ?></label>
        <input id="video-height" type="text" name="height" value="<?php echo $data['height']; ?>" />
    </p>
    <p>
        <label for="video-poster" class="input-title"><?php _e( 'Poster', 'mncf' ); ?></label>
        <input id="video-poster" type="text" name="poster" value="<?php echo $data['poster']; ?>" />
        <span class="help-text"><?php _e('URL for the poster image. Defines image to show as placeholder before the media plays.', 'mncf'); ?></span>
    </p>
</div>
<div class="fieldset form-inline">
    <p>
        <input id="video-loop" type="checkbox" name="loop" value="on" data-bind="checked: ted.params.loop"/>
        <label for="video-loop" class="input-title"><?php _e( 'Loop', 'mncf' ); ?></label>
        <span class="help-text"><?php _e('Allows for the looping of media.', 'mncf'); ?></span>
    </p>
    <p>
        <input id="video-autoplay" type="checkbox" name="autoplay" value="on" data-bind="checked: ted.params.autoplay" />
        <label for="video-autoplay" class="input-title"><?php _e( 'Autoplay', 'mncf' ); ?></label>
        <span class="help-text"><?php _e('Causes the media to automatically play as soon as the media file is ready.', 'mncf'); ?></span>
    </p>
    <p>
        <input id="video-preload" type="checkbox" name="preload" value="on" data-bind="checked: ted.params.preload" />
        <label for="video-preload" class="input-title"><?php _e( 'Preload', 'mncf' ); ?></label>
    </p>
</div>
