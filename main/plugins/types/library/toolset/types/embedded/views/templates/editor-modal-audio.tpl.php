...
<div class="fieldset form-inline">
    <p>
        ...
        <label for="audio-loop" class="input-title"><?php _e( 'Loop', 'mncf' ); ?></label>
    ...
    <p>
        ...
        <label for="audio-autoplay" class="input-title"><?php _e( 'Autoplay', 'mncf' ); ?></label>
    ...
    <p>
        ...
        <label for="audio-preload" class="input-title"><?php _e( 'Preload', 'mncf' ); ?></label>
    </p>
</div>
