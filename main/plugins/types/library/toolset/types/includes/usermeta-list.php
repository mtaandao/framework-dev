 ...
 */
function mncf_admin_usermeta_list()
{
    ...
    ?>
        ...
        <form id="usermeta-filter" method="post">
            ...
            <?php $listTable->search_box(__('Search User Field Groups', 'mncf'), 'search_id'); ?>
 ...
 *
 */
add_action('mncf_admin_footer_mncf-um', 'mncf_admin_fields_list_metabox_to_custom_fields_control');
...
function mncf_admin_fields_list_metabox_to_custom_fields_control()
{
    $form['table-1-open'] = array(
        '#type' => 'markup',
        '#markup' => '<table class="mncf-types-form-table widefat js-mncf-slugize-container"><thead><tr><th>' . __( 'User Field Control', 'mncf' ) . '</th></tr></thead><tbody>',
        '_builtin' => true,
    );
    ...
    $form['table-row-1-content-1'] = array(
        '#type' => 'markup',
        '#markup' => '<p>'.__('You can control User Fields by removing them from the groups, changing type or just deleting.', 'mncf'),
        '_builtin' => true,
    );
