 ...
 * 'size' => 'thumbnail'|'medium'|'large'|'full' (MN predefined sizes)
 ...
 * @return type 
 */
function mncf_fields_image_insert_form() {
    $filename = MNCF_INC_ABSPATH . '/fields/file.php';
    require_once $filename;

    if ( function_exists( 'mncf_fields_file_insert_form' ) ) {
        return mncf_fields_file_insert_form();
    }
}