 ...
 * 'style' => 'text'|'calendar' (display text or MN calendar)
 * 'format' => defaults to MN date format settings, can be any valid date format
 ...
 * @return type 
 */
function mncf_fields_date_insert_form( $form)
{
    $form = array(
        'description' => array(),
        'placeholder' => array(),
    ...
    $form['date_and_time'] = array(
        ...
        '#options' => array(
            'date' => array(
                '#title' => __( 'Input only the date', 'mncf' ),
                '#value' => 'date',
                '#inline' => true,
                '#before' => '<li>',
                '#after' => '</li>',
            ...
            'and_time' => array(
                '#title' => __( 'Input date and time', 'mncf' ),
                '#value' => 'and_time',
                '#inline' => true,
                '#before' => '<li>',
                '#after' => '</li>',
