...
return array(
	...
	'archive-missing' => array(
		...
		'description' => array(
			array(
				'type' => 'paragraph',
				'content' => __( 'Your theme is missing the standard Mtaandao archive for %POST-LABEL-PLURAL%.', 'types' )
			),
			array(
				'type' => 'link',
				'external' => true,
			...
			array(
				...
				'dialog' => array(
					...
					'description' => array(
						array(
							'type' => 'paragraph',
							'content' => __( 'Custom Content plugins let you design archive pages without writing PHP. Your archives will include all
			...
			array(
				...
				'dialog' => array(
					...
					'description' => array(
						array(
							'type' => 'paragraph',
							'content' => __( 'Custom Content plugins let you design archives with custom fields, without writing PHP.', 'types' )
						),
						array(
							'type'   => 'link',
							'class'  => 'button-primary types-button',
	...
	'views-archive-missing' => array(
		...
		'description' => array(
			array(
				'type' => 'paragraph',
				'content' => __( 'There is no Mtaandao Archive for %POST-LABEL-PLURAL%.', 'types' )
			),
			array(
				'type' => 'link',
				'external' => true,
	...
	'views-archive' => array(
		...
		'description' => array(
			array(
				'type' => 'paragraph',
				'content' => __( 'The Mtaandao Archive for %POST-LABEL-PLURAL% is "%POST-VIEWS-ARCHIVE%"', 'types' )
			),
			...
			array(
				'type'   => 'link',
				'class'  => 'button',
				'label'  => __( 'Edit Mtaandao Archive', 'types' ),
