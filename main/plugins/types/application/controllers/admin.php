...
final class Types_Admin {
	...
	private function init_page_extensions() {
		...
		add_action( 'load-toolset_page_mncf-edit-type', array( 'Types_Page_Extension_Edit_Post_Type', 'get_instance' ) );

		// extension for post fields edit page
		add_action( 'load-toolset_page_mncf-edit', array( 'Types_Page_Extension_Edit_Post_Fields', 'get_instance' ) );
	...
	/**
	 * Initialize the extension for the Custom Content Settings page.
	 * 
	 * @since 2.1
	 */
