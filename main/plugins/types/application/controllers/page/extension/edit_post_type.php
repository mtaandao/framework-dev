...
final class Types_Page_Extension_Edit_Post_Type {
	...
	private function __construct() {
		...
		$mncf_post_type = sanitize_text_field( $_GET['mncf-post-type'] );

		Types_Helper_Placeholder::set_post_type( $mncf_post_type );
		Types_Helper_Condition::set_post_type( $mncf_post_type );
