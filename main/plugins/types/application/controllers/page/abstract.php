...
abstract class Types_Page_Abstract {
	 ...
	 *
	 * By default, this disables the Mtaandao Heartbeat API in order to save resources and speed up AJAX calls.
	 *
	 * @since 2.0
	 */
	public function prepare() {
		...
		if ( $this->disable_heartbeat ) {
			mn_deregister_script( 'heartbeat' );
			mn_register_script( 'heartbeat', false );
		}
	}
