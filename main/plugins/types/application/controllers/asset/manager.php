...
/**
 * The script and style asset manager for Types implemented in a standard Custom Content way.
 * 
...
final class Types_Asset_Manager extends Toolset_Assets_Manager {
	...
	// Registered in Custom Content common
	...
	// Mtaandao Core handles
	
	const STYLE_JQUERY_UI_DIALOG = 'mn-jquery-ui-dialog';
