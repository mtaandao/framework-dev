...
final class Types_Field_Utils {
	 ...
	 * @param $domain
	 *
	 * @return MNCF_Field_Definition_Factory
	 * @deprecated Use MNCF_Field_Definition_Factory::get_factory_by_domain() instead.
	 */
	...
	public static function domain_to_legacy_meta_type( $domain ) {
		return mncf_getarr( self::$domain_legacy_value_map, $domain );
	}
	...
	public static function legacy_meta_type_to_domain( $meta_type ) {
		...
		return mncf_getarr( $map, $meta_type );
	}
	 ...
	 *
	 * @return null|MNCF_Field_Instance Field instance or null if an error occurs.
	 * @since 1.9
	 */
	public static function create_term_field_instance( $field_slug, $term_id ) {
		try {
			return new MNCF_Field_Instance_Term( MNCF_Field_Definition_Factory_Term::get_instance()->load_field_definition( $field_slug ), $term_id );
		} catch( Exception $e ) {
			return null;
		}
	}
	 ...
	 *
	 * @param MNCF_Field_Instance $field
	 *
	 * @since 1.9
	 * @return array
	 */
	public static function get_toolset_forms_field_config( $field ) {
		return mntoolset_form_filter_types_field(
