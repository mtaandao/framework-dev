...
class Types_Field_Group_Post extends Types_Field_Group {
	...
	const POST_TYPE = 'mn-types-group';
	 ...
	 * @since unknown
	 */
	const POSTMETA_POST_TYPE_LIST = '_mn_types_group_post_types';


	/**
	 * @param MN_Post $field_group_post Post object representing a post field group.
	...
	/**
	 * @inheritdoc
	 * @return MN_Post[] Individual posts using this group.
	 * @since 2.1
	 */
	...
	public function get_edit_link() {
		return admin_url() . '/admin.php?page=mncf-edit&group_id=' . $this->get_id();
	}
