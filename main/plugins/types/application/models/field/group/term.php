...
class Types_Field_Group_Term extends Types_Field_Group {
	...
	const POST_TYPE = 'mn-types-term-group';
	 ...
	 */
	const POSTMETA_ASSOCIATED_TAXONOMY = '_mn_types_associated_taxonomy';


	/**
	 * Types_Field_Group_Term constructor.
	 *
	 * @param MN_Post $field_group_post Post object representing a term field group.
