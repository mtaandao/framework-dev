...
final class Types_Helper_Url {
	...
	const MN_TYPES_DOMAIN = 'mn-types.com';
	...
	/**
	 * Determines whether an URL points to the mn-types.com domain.
	 *
	 * @param string $url
	 * @return bool
	 * @since 2.1
	 */
	private static function is_link_to_mntypes( $url ) {
		$url_parts = parse_url( $url );
		return ( mncf_getarr( $url_parts, 'host') == self::MN_TYPES_DOMAIN );
	}
	 ...
	 * @param bool $add_site_url If this is true and the URL points to mn-types.com, an additional argument with current
