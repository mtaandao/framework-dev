...
class Types_Helper_Condition_Type_Fields_Assigned extends Types_Helper_Condition {
	...
	public function valid() {
		...
		// query a post
		$query = new MN_Query( 'post_type=' . $post_type->name . '&posts_per_page=1' );
		...
		if( !function_exists( 'mncf_admin_post_get_post_groups_fields') )
			include_once( MNCF_EMBEDDED_ABSPATH . '/includes/fields-post.php' );

		$fields = mncf_admin_post_get_post_groups_fields( $post );
