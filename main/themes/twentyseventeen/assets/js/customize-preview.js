...
(function( $ ) {
	...
	mn.customize.bind( 'preview-ready', function() {

		// Initially hide the theme option placeholders on load
		$( '.panel-placeholder' ).hide();

		mn.customize.preview.bind( 'section-highlight', function( data ) {
	...
	// Color scheme.
	mn.customize( 'colorscheme', function( value ) {
		value.bind( function( to ) {
	...
	// Custom color hue.
	mn.customize( 'colorscheme_hue', function( value ) {
		value.bind( function( to ) {
	...
	// Page layouts.
	mn.customize( 'page_layout', function( value ) {
		value.bind( function( to ) {
			if ( 'one-column' === to ) {
	...
	function hasHeaderImage() {
		var image = mn.customize( 'header_image' )();
		return '' !== image && 'remove-header' !== image;
	}

	// Whether a header video is available.
	function hasHeaderVideo() {
		var externalVideo = mn.customize( 'external_header_video' )(),
			video = mn.customize( 'header_video' )();
	...
	$.each( [ 'external_header_video', 'header_image', 'header_video' ], function( index, settingId ) {
		mn.customize( settingId, function( setting ) {
