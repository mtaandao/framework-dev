...
add_action( 'mn_footer', 'twentyseventeen_include_svg_icons', 9999 );
...
function twentyseventeen_get_svg( $args = array() ) {
	 ...
	 *
	 * See https://core.trac.mtaandao.co.ke/ticket/38387.
	 */
 ...
 * @param  MN_Post $item        Menu item object.
...
function twentyseventeen_social_links_icons() {
	...
	$social_links_icons = array(
		...
		'vine.co'         => 'vine',
		'vk.com'          => 'vk',
		'mtaandao.co.ke'   => 'mtaandao',
		'mtaandao.com'   => 'mtaandao',
		'yelp.com'        => 'yelp',
		'youtube.com'     => 'youtube',
	);
