...
.colors-custom .site-content .mn-playlist-light .mn-playlist-current-item .mn-playlist-item-album {
...
.colors-custom .site-content .mn-playlist-light .mn-playlist-current-item .mn-playlist-item-artist {
...
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:hover,
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:focus {
...
.colors-custom .mn_widget_tag_cloud a:hover,
.colors-custom .mn_widget_tag_cloud a:focus {
...
.colors-custom .mn_widget_tag_cloud a {
...
.colors-custom .site-content .mn-playlist-light .mn-playlist-item,
.colors-custom tr {
	border-bottom-color: hsl( ' . $hue . ', ' . $saturation . ', 93% ); /* base: #eee; */
}

.colors-custom .site-content .mn-playlist-light {
...
.colors-custom .entry-footer .edit-link a.post-edit-link,
.colors-custom .social-navigation a,
.colors-custom .site-content .mn-playlist-light a.mn-playlist-caption:hover,
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:hover a,
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:focus a,
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:hover,
.colors-custom .site-content .mn-playlist-light .mn-playlist-item:focus,
.colors-custom .prev.page-numbers:focus,
.colors-custom .prev.page-numbers:hover,
