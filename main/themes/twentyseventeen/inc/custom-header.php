 ...
 *
 * @link https://mtaandao.github.io/Custom_Headers
 *
 * @package Mtaandao
...
function twentyseventeen_custom_header_setup() {
	 ...
	 *     @type string $mn-head-callback       Callback function used to styles the header image and text
	...
	add_theme_support( 'custom-header', apply_filters( 'twentyseventeen_custom_header_args', array(
		...
		'flex-height'        => true,
		'video'              => true,
		'mn-head-callback'   => 'twentyseventeen_header_style',
	) ) );
