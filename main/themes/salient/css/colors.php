...
$external_dynamic = (!empty($options['external-dynamic-css']) && $options['external-dynamic-css'] == 1) ? 'on' : 'off';
	...
	$social_accent_color_rounded = (!empty($options["sharing_btn_accent_color"]) && $options["sharing_btn_accent_color"] == '1') ? 'body[data-button-style="rounded"] .mnb_wrapper .twitter-share:before, body[data-button-style="rounded"] .mnb_wrapper .twitter-share.hovered:before, body[data-button-style="rounded"] .mnb_wrapper .facebook-share:before, body[data-button-style="rounded"] .mnb_wrapper .facebook-share.hovered:before, body[data-button-style="rounded"] .mnb_wrapper .google-plus-share:before, body[data-button-style="rounded"] .mnb_wrapper .google-plus-share.hovered:before, body[data-button-style="rounded"] .mnb_wrapper .nectar-social:hover > *:before, body[data-button-style="rounded"] .mnb_wrapper .pinterest-share:before, body[data-button-style="rounded"] .mnb_wrapper .pinterest-share.hovered:before, body[data-button-style="rounded"] .mnb_wrapper .linkedin-share:before, body[data-button-style="rounded"] .mnb_wrapper .linkedin-share.hovered:before, ' : null;
	global $woocommerce; 
	if ($woocommerce) {
	...
	.comment-list .comment-meta a:hover, label span, .mncf7-form p span, .icon-3x[class^="icon-"], .icon-3x[class*=" icon-"], .icon-tiny[class^="icon-"], body .circle-border, article.result .title a, .home .blog-recent .col .post-header a:hover,
	...
	#footer-outer #flickr a:hover img, '.$social_accent_color_rounded.' #featured article .post-title a:hover, #header-outer[data-lhe="animated_underline"] header#top nav > ul > li > a:after, body #featured article .post-title a:hover, div.mncf7-validation-errors, body[data-fancy-form-rcs="1"] [type="radio"]:checked + label:before, body[data-fancy-form-rcs="1"] [type="radio"]:checked + label:after, body[data-fancy-form-rcs="1"] input[type="checkbox"]:checked + label > span, .select2-container .select2-choice:hover, .select2-dropdown-open .select2-choice,
	...
	if($page_full_screen_rows_animation == 'parallax') {
		echo '#nectar_fullscreen_rows > .mnb_row .full-page-inner-wrap { background-color: '.$page_full_screen_rows_bg_color.'; }';
	}
