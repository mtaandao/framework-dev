...
/***************** Pretty Photo ******************/
	...
	function magnificInit() {
		...
		$('a.magnific.gallery').each(function(){
			...
			var $parentRow = ($(this).parents('.mnb_row').length > 0) ? $(this).parents('.mnb_row') : $(this).parents('.row');
...
if($('#nectar_fullscreen_rows').length > 0 || $().fullpage) {
	...
	function setFPNavColoring(index,direction) {
		...
		if($('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+')').find('.span_12.light').length > 0) {
	...
	function setFPNames() {
		$anchors = [];
		$names = [];
		$('#nectar_fullscreen_rows > .mnb_row').each(function(i){
	...
	function initFullPageFooter() {
		...
		if($footerPos == 'default') {
			$('#footer-outer').appendTo('#nectar_fullscreen_rows').addClass('fp-auto-height').addClass('fp-section').addClass('mnb_row').attr('data-anchor',' ').wrapInner('<div class="span_12" />').wrapInner('<div class="container" />').wrapInner('<div class="full-page-inner" />').wrapInner('<div class="full-page-inner-wrap" />').wrapInner('<div class="full-page-inner-wrap-outer" />');
		}
		else if($footerPos == 'last_row') {
			$('#footer-outer').remove();
			$('#nectar_fullscreen_rows > .mnb_row:last-child').attr('id','footer-outer').addClass('fp-auto-height');
		} else {
			$('#footer-outer').remove();
		}
	...
	function fullscreenRowLogic() {
		$('.full-page-inner-wrap .full-page-inner > .span_12 > .mnb_column').each(function(){
			if($(this).find('> .vc_column-inner > .mnb_wrapper').find('> .mnb_row').length > 0) {

				//add class for css
				$(this).find('> .vc_column-inner > .mnb_wrapper').addClass('only_rows');

				//set number of rows for css
				$rowNum = $(this).find('> .vc_column-inner > .mnb_wrapper').find('> .mnb_row').length;
				$(this).find('> .vc_column-inner > .mnb_wrapper').attr('data-inner-row-num',$rowNum);
			} 

			else if($(this).find('> .column-inner-wrap > .column-inner > .mnb_wrapper').find('> .mnb_row').length > 0) {

				//add class for css
				$(this).find('> .column-inner-wrap > .column-inner > .mnb_wrapper').addClass('only_rows');

				//set number of rows for css
				$rowNum = $(this).find('> .column-inner-wrap > .column-inner > .mnb_wrapper').find('> .mnb_row').length;
				$(this).find('> .column-inner-wrap > .column-inner > .mnb_wrapper').attr('data-inner-row-num',$rowNum);
			}
		});
	}
	...
	function fullHeightRowOverflow() {
		...
		if($(window).width() >= 1000) {
	    	...
	    	$('#nectar_fullscreen_rows > .mnb_row .full-page-inner-wrap[data-content-pos="full_height"]').each(function(){
	    		...
	    		$(this).find('> .full-page-inner > .span_12 > .mnb_column > .vc_column-inner > .mnb_wrapper').each(function(){
	    			 columnPaddingTop = parseInt($(this).parents('.mnb_column').css('padding-top'));
	    			 columnPaddingBottom = parseInt($(this).parents('.mnb_column').css('padding-bottom'));
	    	...
	    	$('#nectar_fullscreen_rows > .mnb_row').each(function(){
	    		$totalColHeight = 0;
	    		$(this).find('.fp-scrollable > .fp-scroller > .full-page-inner-wrap-outer > .full-page-inner-wrap[data-content-pos="full_height"] > .full-page-inner > .span_12 > .mnb_column').each(function(){
	...
	$('#nectar_fullscreen_rows[data-row-bg-animation="ken_burns"] > .mnb_row:first-child .row-bg.using-image').addClass('kenburns');
	setTimeout(function(){
		//ken burns first slide fix
		$('#nectar_fullscreen_rows[data-row-bg-animation="ken_burns"] > .mnb_row:first-child .row-bg.using-image').removeClass('kenburns');
	},500);
	...
	function initNectarFP() {
		...
		$fullscreenSelector = '.mnb_row.active ';

		$('.container-wrap, .container-wrap .main-content > .row').css({'padding-bottom':'0', 'margin-bottom': '0'});
		$('#nectar_fullscreen_rows').fullpage({
			sectionSelector: '#nectar_fullscreen_rows > .mnb_row',
			navigation: true,
			css3: true,
			...
			afterLoad: function(anchorLink, index, slideAnchor, slideIndex){ 
				...
				if($('#nectar_fullscreen_rows').hasClass('afterLoaded')) {
					...
					$('.mnb_row:not(.last-before-footer):not(:nth-child('+index+')) .fp-scrollable').each(function(){
						$scrollable = $(this).data('iscrollInstance');
						$scrollable.scrollTo(0,0);
					});

					//reset carousel
					$('.mnb_row:not(:nth-child('+index+')) .owl-carousel').trigger('to.owl.carousel',[0]);

					var $row_id = $('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+')').attr('id');

					$('#nectar_fullscreen_rows > .mnb_row').removeClass('transition-out').removeClass('trans');
					

					$('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+')').removeClass('next-current');
					$('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+') .full-page-inner-wrap-outer').css({'height': '100%'});
					$('#nectar_fullscreen_rows > .mnb_row .full-page-inner-wrap-outer').css({'transform':'none'});
					//take care of nav/control coloring
					//setFPNavColoring(index,'na');
					
					//handle waypoints
					if($row_id != 'footer-outer' && $('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+').last-before-footer').length == 0) {
					...
					if($row_id !='footer-outer') {
						$('#nectar_fullscreen_rows > .mnb_row').removeClass('last-before-footer').css('transform','initial');

						//reset animation attrs
						$('#nectar_fullscreen_rows > .mnb_row:not(.active):not(#footer-outer)').css({'transform':'translateY(0)','left':'-9999px', 'transition': 'none', 'opacity':'1', 'will-change':'auto'});
						$('#nectar_fullscreen_rows > .mnb_row:not(#footer-outer)').find('.full-page-inner-wrap-outer').css({'transition': 'none',  'transform':'none', 'will-change':'auto'});
						$('#nectar_fullscreen_rows > .mnb_row:not(#footer-outer)').find('.fp-tableCell').css({'transition': 'none', 'transform':'none', 'will-change':'auto'});
					}
				} else {
	        ...
	        onLeave: function(index, nextIndex, direction){ 
	        	...
	        	var $row_id = $('#nectar_fullscreen_rows > .mnb_row:nth-child('+nextIndex+')').attr('id');
	        	var $indexRow = $('#nectar_fullscreen_rows > .mnb_row:nth-child('+index+')');
	        	var $nextIndexRow = $('#nectar_fullscreen_rows > .mnb_row:nth-child('+nextIndex+')');
	        	...
	        	if( $row_id == 'footer-outer') {
	        		...
	        		$('#nectar_fullscreen_rows > .mnb_row.last-before-footer').css('transform','translateY(0px)');
	...
	$(window).smartresize(function(){
		...
		if($('#nectar_fullscreen_rows').length > 0) {
			setTimeout(function(){
				$('.mnb_row:not(.last-before-footer) .fp-scrollable').each(function(){
					$scrollable = $(this).data('iscrollInstance');
					$scrollable.refresh();
				});
			},200);
	...
	function startMouseParallax(){
		if($('#nectar_fullscreen_rows > .mnb_row.active .nectar-parallax-scene').length > 0) {
			$.each($mouseParallaxScenes,function(k,v){
				v.parallax('enable');
			});
		}
	...
	function resetWaypoints() {
		...
		$('.col.has-animation.animated-in:not([data-animation*="reveal"]), .mnb_column.has-animation.animated-in:not([data-animation*="reveal"])').css({'transition':'none'});
		$('.col.has-animation.animated-in:not([data-animation*="reveal"]), .mnb_column.has-animation.animated-in:not([data-animation*="reveal"]), .nectar_cascading_images .cascading-image:not([data-animation="none"]) .inner-wrap').css({'opacity':'0','transform':'none','left':'auto','right':'auto'}).removeClass('animated-in');	
		$('.col.has-animation.boxed:not([data-animation*="reveal"]), .mnb_column.has-animation.boxed:not([data-animation*="reveal"])').addClass('no-pointer-events');

		//reveal columns
		$('.mnb_column.has-animation[data-animation*="reveal"], .nectar_cascading_images').removeClass('animated-in');
		if(overallWidth > 1000 && $('.using-mobile-browser').length == 0) {
			$('.mnb_column.has-animation[data-animation="reveal-from-bottom"] > .column-inner-wrap').css({'transition':'none','transform':'translate(0, 100%)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-bottom"] > .column-inner-wrap > .column-inner').css({'transition':'none','transform':'translate(0, -90%)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-top"] > .column-inner-wrap').css({'transition':'none','transform':'translate(0, -100%)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-top"] > .column-inner-wrap > .column-inner').css({'transition':'none','transform':'translate(0, 90%)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-left"] > .column-inner-wrap').css({'transition-duration':'0s','transform':'translate(-100%, 0)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-left"] > .column-inner-wrap > .column-inner').css({'transition-duration':'0s','transform':'translate(90%, 0)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-right"] > .column-inner-wrap').css({'transition-duration':'0s','transform':'translate(100%, 0)'});
			$('.mnb_column.has-animation[data-animation="reveal-from-right"] > .column-inner-wrap > .column-inner').css({'transition-duration':'0s','transform':'translate(-90%, 0)'});
		}
		$('.mnb_column.has-animation[data-animation*="reveal"] > .column-inner-wrap, .mnb_column.has-animation[data-animation*="reveal"] > .column-inner-wrap > .column-inner').removeClass('no-transform');
			...
			var waypoint = new Waypoint({
	 			element: $that,
	 			 handler: function(direction) {
	 			 	...
	 			 	if($that.parents('.mnb_tab').length > 0 && $that.parents('.mnb_tab').css('visibility') == 'hidden' || $that.hasClass('animated-in')) { 
					     waypoint.destroy();
					     return;
					}
...
/***************** Tabbed ******************/
	...
	$('body').on('click','.tabbed > ul li:not(.cta-button) a',function(){
		...
		if($tabbedClickCount != 0) {
			...
			if($(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('img.img-with-animation').length > 0 ||
			   ...
			   $(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('.mnb_column.has-animation').length > 0 ) {
				colAndImgAnimations();
			...
			if($(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('.nectar-split-heading').length > 0 ) 
				splitLineHeadings();
			if($(this).parents('.mnb_row').length > 0) {
				if($(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('.vc_pie_chart').length > 0  ||
				   $(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('.mn-video-shortcode').length > 0 ||
				   $(this).parents('.tabbed').find('> div:nth-of-type('+$id+')').find('.twentytwenty-container').length > 0 ||
				   $(this).parents('.mnb_row').next().hasClass('parallax_section'))
					$(window).trigger('resize');
		...
		$(this).parents('.tabbed').find('.mnb_row').each(function(){
	...
	function tabbedInit(){ 
		$('.tabbed').each(function(){
			if($(this).find('.swiper-container').length == 0 && $(this).find('.testimonial_slider').length == 0 && $(this).find('.portfolio-items:not(".carousel")').length == 0 && $(this).find('.mnb_gallery .portfolio-items').length == 0 && $(this).find('iframe').length == 0){
				$(this).find('> ul li:first-child a').click();
			}	
			if($(this).find('.testimonial_slider').length > 0 || $(this).find('.portfolio-items:not(".carousel")').length > 0 || $(this).find('.mnb_gallery .portfolio-items').length > 0 || $(this).find('iframe').length > 0 ){
				var $that = $(this);
				
				$(this).find('.mnb_tab').show().css({'opacity':0,'height':'1px'});
				$(this).find('> ul li a').addClass('loading');
				
				setTimeout(function(){ 
					$that.find('.mnb_tab').hide().css({'opacity':1,'height':'auto'}); 
	...
	$('.mnb_column').each(function(i){
		...
		if($(this).attr('data-has-bg-color') == 'true') {
			if($(this).is('[data-animation*="reveal"]') && $(this).hasClass('has-animation')) 
				$columnColorCSS += '.mnb_column.instance-'+i+ ' .column-inner-wrap .column-inner:before { background-color:' + $(this).attr('data-bg-color') + ';  opacity: '+$(this).attr('data-bg-opacity')+'; }';
			else 
				$columnColorCSS += '.mnb_column.instance-'+i+ ':before { background-color:' + $(this).attr('data-bg-color') + ';  opacity: '+$(this).attr('data-bg-opacity')+'; }';
		}

		//hover bg color
		if($(this).is('[data-hover-bg^="#"]')) {
			if($(this).is('[data-animation*="reveal"]') && $(this).hasClass('has-animation')) 
				$columnColorCSS += '.mnb_column.instance-'+i+ ':hover .column-inner:before { background-color: '+$(this).attr('data-hover-bg') + '; opacity: '+$(this).attr('data-hover-bg-opacity')+'; }';
			else 
	   			$columnColorCSS += '.mnb_column.instance-'+i+ ':hover:before { background-color: '+$(this).attr('data-hover-bg') + '; opacity: '+$(this).attr('data-hover-bg-opacity')+'; }';
...
function rowColorOverlay() {	
	...
	$('.row > .mnb_row > .row-bg-wrap > .row-bg[data-color_overlay],  #nectar_fullscreen_rows .full-page-inner-wrap > .full-page-inner > .row-bg-wrap > .row-bg[data-color_overlay], #portfolio-extra > .mnb_row > .row-bg-wrap > .row-bg[data-color_overlay], .single #post-area .content-inner > .mnb_row > .row-bg-wrap > .row-bg[data-color_overlay]').each(function(i){
...
function morphingOutlines() {
	...
	if($('.morphing-outline').length > 0) {
		...
		$('.morphing-outline').each(function(i){
			...
			$morphingOutlineCSS += 'body .mnb_column:hover > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner > *, body .mnb_column:hover > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner > * { color: '+$(this).attr("data-hover-color")+'; } ';
			$morphingOutlineCSS += 'body .mnb_column:hover > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column:hover > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after  { border-color: '+$(this).attr("data-hover-color")+'; } ';
			//padding calcs
			$morphingOutlineCSS += 'body .mnb_column'+$hover2+' > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column'+$hover2+' > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after { padding: '+(($width+100 + $border*2 - $height)/2 - $border) +'px 50px}';
			$morphingOutlineCSS += '.morphing-outline.instance-'+i+' { padding: '+(30+($width+80 + $border*2 - $height)/2 - $border) +'px 50px}'; //extra space on the outer for mobile/close elements
			$morphingOutlineCSS += 'body .mnb_column'+$hover2+' > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column'+$hover2+' > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after { top: -'+ parseInt((($width+100 + $border*2 - $height)/2 - $border) + $border)+ 'px }';

			$morphingOutlineCSS += 'body .mnb_column > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after { left: -' + parseInt(50+$border) + 'px }';
			////hover
			$morphingOutlineCSS += 'body .mnb_column'+$hover+' > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column'+$hover+' > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after { padding: 50px 50px}';
			$morphingOutlineCSS += 'body .mnb_column'+$hover+' > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after, body .mnb_column'+$hover+' > .vc_column-inner > .mnb_wrapper > .morphing-outline.instance-'+i+' .inner:after { top: -'+parseInt(50+$border) +'px }';
...
/***************** Full Width Section ******************/
	...
	function fwsClasses() {
		...
		$('.mnb_wrapper > .nectar-slider-wrap[data-full-width="true"]').each(function(){
			if(!$(this).parent().hasClass('span_9') && !$(this).parent().hasClass('span_3') && $(this).parent().attr('id') != 'sidebar-inner'){
				if($(this).parents('.mnb_row').index() == '0'){
		...
		if($('#portfolio-extra').length == 0) {
			$contentElementsNum = ($('.main-content > .row > .mnb_row').length > 0) ? $('.main-content > .row > .mnb_row').length : $('.main-content > .row > .full-width-section').length;
		} else {
			$contentElementsNum = $('.main-content > .row #portfolio-extra > *').length;
		}

		$('.full-width-section, .full-width-content:not(.page-submenu .full-width-content), .row > .nectar-slider-wrap[data-full-width="true"], .mnb_wrapper > .nectar-slider-wrap[data-full-width="true"], .parallax_slider_outer, .portfolio-items[data-col-num="elastic"]').each(function(){
			...
			if(!$(this).parent().hasClass('span_9') && !$(this).parent().hasClass('span_3') && $(this).parent().attr('id') != 'sidebar-inner'){
				...
				if($(this).parents('.mnb_row').length > 0){ 
					...
					////first
					if($(this).parents('.mnb_row').index() == '0' && $('#page-header-bg').length != 0 || $(this).parents('.mnb_row').index() == '0' && $('.parallax_slider_outer').length != 0){
						//$(this).css('margin-top','-2.1em').addClass('first-section nder-page-header');
					} 
					else if($(this).parents('.mnb_row').index() == '0' && $('#page-header-bg').length == 0 && $('.page-header-no-bg').length == 0 
					         && $('.project-title').length == 0 && $(this).parents('.mnb_row').index() == '0' 
					...
					if($(this).parents('.mnb_row').index() == $contentElementsNum-1 && $('#respond').length == 0 ) { 
		...
		$('.full-width-section.mnb_row, .full-width-content.mnb_row').each(function(){
		...
		$('.portfolio-filters-inline').each(function(){
			...
			if($(this).parents('.mnb_row').length > 0){ 
				...
				}  else if($(this).parents('.mnb_row').index() == '0' && $('#page-header-bg').length == 0 || $(this).parents('.mnb_row').index() == '0' && $('.parallax_slider_outer').length == 0){
	...
	//if( $('.mnb_row.first-section:not(".full-width-content") .nectar-slider-wrap').length > 0 && $('.mnb_row.first-section:not(".full-width-content") .nectar-slider-wrap').attr('data-full-width') != 'true' || $('.mnb_row.first-section:not(".full-width-content") .nectar-slider-wrap').length > 0 && $('.mnb_row.first-section:not(".full-width-content") .nectar-slider-wrap').attr('data-full-width') != 'boxed-full-width' ) $('body').attr('data-bg-header','false');
	...
	function fullWidthContentColumns(){
		...
		//standard carousel
			...
			if($(this).find('> .span_12 > .col').length > 1){
				...
				$(this).find('> .span_12 > .col').each(function(){
					...
					$column_inner_selector = ($(this).find('> .vc_column-inner > .mnb_wrapper').length > 0) ? '.vc_column-inner' : '.column-inner-wrap > .column-inner';
					
					var $padding = parseInt($(this).css('padding-top'));
					//var $padding = (!$(this).is('[data-animation*="reveal"]')) ? parseInt($(this).css('padding-top')) : parseInt($(this).find('> .column-inner-wrap > .column-inner').css('padding-top')); start to reveal fix
					($(this).find('> '+$column_inner_selector+' > .mnb_wrapper').height() + ($padding*2) > tallestColumn) ? tallestColumn = $(this).find('> '+$column_inner_selector+' > .mnb_wrapper').height() + ($padding*2)  : tallestColumn = tallestColumn;
				});	
	    	 	...
	    	 	$(this).find('> .span_12 > .col').each(function(){
		    	 	...
		    	 	if($(this).find('> '+$column_inner_selector+' > .mnb_wrapper > *').length > 0){
	         	...
	         	var $childRows = $(this).find('> .span_12 > .col .mnb_row').length;
	         	if(window.innerWidth > 1000) { 
	         		
	         		var $padding = parseInt($(this).find('> .span_12 > .col').css('padding-top'));
	         		
	         		//$(this).find('> .span_12 > .col .mnb_row .col').css('min-height',(tallestColumn-($padding*2))/$childRows + 'px'); 
	         	} else {
	         		$(this).find('> .span_12 > .col .mnb_row .col').css('min-height','0px'); 
	         	}
	         	...
	         	if($(this).hasClass('vertically-align-columns') && window.innerWidth > 1000 && !$(this).hasClass('vc_row-o-equal-height')){
		         	...
		         	$(this).find('> .span_12 > .col').each(function(){
						...
						$columnInnerHeight = $(this).find('> '+$column_inner_selector+' > .mnb_wrapper').height();
						var $marginCalc = ($(this).height()/2)-($columnInnerHeight/2);
						if($marginCalc <= 0) $marginCalc = 0;
						
						$(this).find('> '+$column_inner_selector+' > .mnb_wrapper').css('margin-top',$marginCalc);
						$(this).find('> '+$column_inner_selector+' > .mnb_wrapper').css('margin-bottom',$marginCalc);
		...
		$('.main-content > .row > .mnb_row:not(.full-width-content).vc_row-o-equal-height').each(function(){
			if($(this).find('>.span_12>.mnb_column[data-animation*="reveal"]').length >0) {
				var tallestColumn = 0;
				var $columnInnerHeight = 0;
				...
				$(this).find('> .span_12 > .col').each(function(){
	    	 	...
	    	 	$(this).find('> .span_12 > .col').each(function(){
	    	 		...
	    	 		//columns with content
		    	 	if($(this).find('> .column-inner-wrap > .column-inner .mnb_wrapper > *').length > 0){
		...
		$('.vc_row.vc_row-o-equal-height>.span_12>.mnb_column[class*="padding-"][data-padding-pos="all"]').each(function(){
...
function mouseParallaxInit(){
	$('.mnb_row:has(.nectar-parallax-scene)').each(function(i){
...
function colAndImgAnimations(){
	...
	$($fullscreenSelector+'.col.has-animation:not([data-animation*="reveal"]), '+$fullscreenSelector+'.mnb_column.has-animation:not([data-animation*="reveal"])').each(function() {
	...
	$($fullscreenSelector+'.mnb_column.has-animation[data-animation*="reveal"]').each(function() {
...
function cascadingImageBGSizing() {
	$('.nectar_cascading_images').each(function(){
		...
		if($(this).parents('.vc_row-o-equal-height').length > 0 && $(this).parents('.mnb_column').length > 0) 
			$(this).css('max-width',$(this).parents('.mnb_column').width());
		...
		var waypoint = new Waypoint({
 			element: $that,
 			 handler: function(direction) {
					...
					if($that.parents('.mnb_tab').length > 0 && $that.parents('.mnb_tab').css('visibility') == 'hidden' || $that.hasClass('completed')) { 
						 waypoint.destroy();
						return;
					}
...
$('.nectar-icon-list[data-icon-style="border"]').each(function(){
	if($(this).parents('.mnb_row').length > 0 && $(this).parents('.mnb_row').find('.row-bg.using-bg-color').length > 0) {
		var $bgColorToSet = $(this).parents('.mnb_row').find('.row-bg.using-bg-color').css('background-color');
	}
	else {
		if($('#nectar_fullscreen_rows').length > 0)
			var $bgColorToSet = $('#nectar_fullscreen_rows > .mnb_row .full-page-inner-wrap').css('background-color');
		else 
...
function imageWithHotspotClickEvents() {
	...
	$('body').on('click','.nectar_hotspot.click',function(){
		...
		if($(window).width() <= 690) $(this).parents('.mnb_row, [class*="vc_col-"]').css('z-index','200');
	...
	$('body').on('click','.nectar_hotspot.open',function(){
		...
		$(this).parents('.mnb_row').css('z-index','auto');
		return false;
	});
...
function videoshortcodeSize(){
	$('.mn-video').each(function(){

		$(this).attr('data-aspectRatio', parseInt($(this).find('.mejs-overlay').height()) / parseInt($(this).find('.mn-video-shortcode').css('width')));

		var newWidth = $(this).width();
	 	 
		var $el = $(this).find('.mn-video-shortcode');
...
/***************** Nectar Video BG ******************/
	...
	$('.mnb_row:has(".nectar-video-wrap"):not(.fp-section)').each(function(i){
	...
	function resizeVideoToCover() {
		$('.nectar-video-wrap').each(function(i){
			...
			if($(this).parents('#page-header-bg').length > 0) {
				...
				var $containerHeight = $(this).parents('.mnb_row').outerHeight();			
				var $containerWidth = $(this).parents('.mnb_row').outerWidth();
			}
    ...
    function videoBGInit(){
		...
		if(navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/)){
			$('.mnb_row .mobile-video-image, #page-header-wrap .mobile-video-image, .fullscreen-header .mobile-video-image').show();
...
function fullScreenHeaderInit(){
	...
	if($('.fullscreen-header').length > 0) {
		...
		var extraHeight = ($('#mnadminbar').length > 0) ? $('#mnadminbar').height() : 0; //admin bar
...
function boxRoll(e,d) {
	...
	if(perspect == 'not-rolled' && animating == 'false' && d == -1) {
		...
		setTimeout(function(){
			$('#header-outer, #mnadminbar, .cart-outer .cart-menu, .midnightHeader .midnightInner').animate({'padding-right': $('body').attr('data-scrollbar-width')},250);
		...
		setTimeout(function(){ 
			...
			$('#header-outer, #mnadminbar, .container-wrap, .cart-outer .cart-menu, .midnightHeader .midnightInner').stop().css('padding-right',0);
		...
		$('#header-outer, #mnadminbar, .container-wrap, .cart-outer .cart-menu, .midnightHeader .midnightInner').css('padding-right',$('body').attr('data-scrollbar-width') + 'px');
		$('.nectar-slider-wrap').transition({'opacity':0},600,'easeOutCubic');
		$('.container-wrap .main-content > .row > div > div[class*="col"]').stop(true).css({'opacity':0});
		setTimeout(function(){
			$('#header-outer, #mnadminbar, .cart-outer .cart-menu, .midnightHeader .midnightInner').animate({'padding-right': 0},250);
...
function updateRowRightPadding(d){
	$('.mnb_row.full-width-section').each(function(){
	...
	$('.mnb_row.full-width-content').each(function(){
...
/***************** Nav ******************/
	...
	function headerOffsetAdjustCalc() {
		if($('body.mobile').length > 0) {
			var $eleHeight = 0;
			var $endOffset = ($('#mnadminbar').css('position') == 'fixed') ? $('#mnadminbar').height() : 0;
			if($('#header-secondary-outer').length > 0) $eleHeight += $('#header-secondary-outer').height();
			if($('#mnadminbar').length > 0) $eleHeight += $('#mnadminbar').height();
	...
	if($('#header-outer[data-mobile-fixed="1"]').length > 0 && $('#mnadminbar').length > 0 || $('#header-outer[data-mobile-fixed="1"]').length > 0 && $('#header-secondary-outer').length > 0) {
	...
	function footerRevealCalcs() {
		if($(window).height() - $('#mnadminbar').height() - $('#header-outer').outerHeight() - $('#footer-outer').height() - 1 -$('#page-header-bg').height() -$('.parallax_slider_outer').height() - $('.page-header-no-bg').height() > 0) {
			$resizeExtra = ($('#header-outer[data-header-resize="1"]').length > 0) ? 55: 0;
			$('.container-wrap').css({'margin-bottom': $('#footer-outer').height()-1, 'min-height': $(window).height() - $('#mnadminbar').height() - $('#header-outer').outerHeight() - $('#footer-outer').height() -1  - $('.page-header-no-bg').height() -$('#page-header-bg').height() -$('.parallax_slider_outer').height() + $resizeExtra });
		} else {
	...
	var adminBarHeight = ($('#mnadminbar').length > 0) ? $('#mnadminbar').height() : 0; //admin bar
	...
	function headerRowColorInheritInit(){
		if($('body[data-header-inherit-rc="true"]').length > 0 && $('.mobile').length == 0){
			...
			$('.main-content > .row > .mnb_row').each(function(){
				...
				var waypoint = new Waypoint({
		 			...
		 			handler: function(direction) {
						...
						if(direction == 'down') {
							...
							if($that.prev('div.mnb_row').find('.row-bg.using-bg-color').length > 0) {
								var $textColor = ($that.prev('div.mnb_row').find('> .col.span_12.light').length > 0) ? 'light-text' : 'dark-text';
								$('#header-outer').css('background-color',$that.prev('div.mnb_row').find('.row-bg').css('background-color')).removeClass('light-text').removeClass('dark-text').addClass($textColor);
								$('#header-outer').attr('data-current-row-bg-color', $that.prev('div.mnb_row').find('.row-bg').css('background-color'));
							} else {
								$('#header-outer').css('background-color',$('#header-outer').attr('data-user-set-bg')).removeClass('light-text').removeClass('dark-text');
								$('#header-outer').attr('data-current-row-bg-color',$('#header-outer').attr('data-user-set-bg'));
							}
...
/****************sticky page submenu******************/
	if($('.page-submenu[data-sticky="true"]').length > 0 && $('#nectar_fullscreen_rows').length == 0) {
		...
		(function() {
		  ...
		  $(window).on('smartresize',function(){
		  	...
		  	$offsetHeight = 0; 
		  	  ...
		  	  if($('#mnadminbar').length > 0 && $('#mnadminbar').css('position') == 'fixed') $offsetHeight += $('#mnadminbar').height();
 			 ...
 			 if($('.page-submenu.stuck').length > 0) {
		        	...
		        	$('.page-submenu.stuck').parents('.mnb_row').css('z-index',10000);
		        	...
		        	$('.page-submenu.stuck').css('top','0').removeClass('stuck');
		       	   $('.page-submenu.stuck').parents('.mnb_row').css('z-index','auto');
		    ...
		    this.waypoint = new Waypoint($.extend({}, this.options, {
		      ...
		      handler: $.proxy(function(direction) {
		        ...
		        if(shouldBeStuck) {
		        	...
		        	this.$element.parents('.mnb_row').css('z-index',10000);
		...
		if($('.page-submenu').parents('.span_12').find('> .mnb_column').length > 1){
			var pageMenu = $('.page-submenu').clone();
			var pageMenuParentRow = $('.page-submenu').parents('.mnb_row');
			$('.page-submenu').remove();
	...
	if($('#nectar_fullscreen_rows').length == 0)
		$('.page-submenu').parents('.mnb_row').css('z-index',10000);
...
/*-------------------------------------------------------------------------*/	
		...
		$('.blog-recent[data-style="title_only"]').each(function(){
			...
			if($(this).parent().parent().parent().hasClass('vc_col-sm-3') || 
				...
				if($('body.mobile').length == 0 && $(this).next('div').length == 0) {
					...
					$(this).parents('.span_12').find(' > .mnb_column').each(function(){
						(Math.floor($(this).height()) > tallestColumn) ? tallestColumn = Math.floor($(this).height()) : tallestColumn = tallestColumn;
					});	
			
					if(Math.floor($(this).find('> .col').outerHeight(true)) < Math.floor($(this).parents('.mnb_row').height()) - 1) {
		...
		function recentPostSliderHeight(){
			...
			$('.nectar-recent-posts-slider').each(function(){
						...
						if( window.innerWidth > 1000 && $('#boxed').length == 0) {
							...
							//column sliders
							var $parentCol = ($(this).parents('.mnb_column').length > 0) ? $(this).parents('.mnb_column') : $(this).parents('.col') ;
	...
	function style6Img(){
		...
		//set parent zindex
		$('.style-5').parents('.mnb_row').css('z-index','100');
			...
			$('#post-area.infinite_scroll .posts-container').infinitescroll({
		   	...
		   	if($('.masonry.meta_overlaid').length == 0) { 
				...
				$(newElements).find('.flex-gallery').each(function(){
			   	...
			   	//media players
			   	if($().mediaelementplayer) $(newElements).find('.mn-audio-shortcode, .mn-video-shortcode').mediaelementplayer();
...
$('body').on('click','#header-outer nav .sf-menu a, #footer-outer .nectar-button, .container-wrap a:not(.mnb_tabs_nav a):not(.woocommerce-tabs a), .swiper-slide .button a, #slide-out-widget-area a, #mobile-menu .container ul li a, #slide-out-widget-area .inner div a',function(e){
...
if($('.nectar-box-roll').length == 0 && $('#nectar_fullscreen_rows').length == 0) $(window).load(pageLoadHash);
	...
	function reLayout() {
		...
		$.each($portfolio_containers,function(i){
			...
			if($portfolio_containers[i].hasClass('no-masonry') && $portfolio_containers[i].find('.col:first:visible').length > 0 && $portfolio_containers[i].parents('.mnb_gallery').length == 0){
    ...
    function masonryBlogInit() {
		...
		if($posts_container.parent().hasClass('masonry')) { 
			...
			if($posts_container.parent().hasClass('masonry') && $posts_container.parent().hasClass('full-width-content')){
				...
				if( $posts_container.parents('.mnb_row').length > 0 ) $posts_container.parents('.mnb_row').css('z-index',100);
...
/*-------------------------------------------------------------------------*/	
	 ...
	 function crossBrowserFixes() {
		...
		//contact form
		$('.mncf7-form p:has(input[type=submit])').css('padding-bottom','0px');

		$('.full-width-content .mncf7-submit').on('click',function(){ setTimeout(function(){ fullWidthContentColumns() },1000); setTimeout(function(){ fullWidthContentColumns() },2000); });
		...
		$('.container-wrap .row > .mnb_row').each(function(){
			if($(this).find('> .span_12 > .mnb_column > .mnb_wrapper').length > 0 && $(this).find('> .span_12 > .mnb_column > .mnb_wrapper').find('*').length == 0) $(this).find('> .span_12 ').remove();
		});
		...
		$('.full-width-content .mnb_column .nectar-slider-wrap[data-full-width="true"]').attr('data-full-width','false');	

		if( $('.nectar-slider-wrap.first-section').length == 0 && 
			$('.full-width-section.first-section > .span_12 > .vc_span12 > .mnb_wrapper > .nectar-slider-wrap').length == 0  && 
			$('.parallax_slider_outer.first-section').length == 0 && 
			$('.full-width-content.first-section .mnb_wrapper > .nectar-slider-wrap').length == 0  && 
			!($('.mnb_row.first-section > .nectar-parallax-scene').length == 1 && $('#header-outer[data-transparent-header="true"]').length == 1) ) { 
	...
	function convertPlaceholders() {
		$('form input[placeholder], form textarea[placeholder]').each(function(i){
			if($(this).attr('placeholder').length > 1) {
				...
				if($(this).parents('.mncf7-form-control-wrap').length == 0) {
					if($(this).prev('label').length == 0 || $(this).is('textarea')) {
						$('<label for="'+$inputID+'">'+$placeholder+'</label>').insertBefore($(this));
					}
				} else {
					if($(this).parents('.mncf7-form-control-wrap').find('label').length == 0) {
						$('<label for="'+$inputID+'">'+$placeholder+'</label>').insertBefore($(this).parents('.mncf7-form-control-wrap '));
					}
				}
...
if($('body[data-fancy-form-rcs="1"]').length > 0) {
    ...
    ////for cf7
    $('.mncf7-radio .mncf7-list-item-label').each(function(i){
    	var $data = $(this).html();
     ...
     $('.mncf7-checkbox .mncf7-list-item-label').each(function(){
    	var $data = $(this).html();
    ...
    $('select:not(.comment-form-rating #rating)').each(function(){
    	...
    	if($(this).parents('.mncf7-form-control-wrap').length > 0) {
	    	...
	    	if($(this).parents('.mncf7-form-control-wrap').find('.select2-container').length > 0) {
	    	...
	    	//if label is found
	    	if($selector.parents('.mncf7-form-control-wrap').parent().find('label').length == 1) {
	    		$selector.parents('.mncf7-form-control-wrap').parent().wrapInner('<div class="fancy-select-wrap" />');
	    	} else {
	    		//default wrap
	...
	function initPage(e) {
		...
		//cf7
		if($().mncf7InitForm) $('div.mncf7 > form').mncf7InitForm();
		...
		$('.mn-video-shortcode.mejs-container').each(function(){
			$(this).attr('data-aspectRatio', parseInt($(this).css('height')) / parseInt($(this).css('width')));
		});

		//mediaElement
		$('video.mn-media-shortcode-ajax, audio.mn-media-shortcode-ajax').each(function(){ 
		...
		$('.mnb_row:has(".nectar-video-wrap")').each(function(i){
			$(this).css('z-index',100 + i);
		});
