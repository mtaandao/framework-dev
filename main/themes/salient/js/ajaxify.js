...
(function ($) {
    var Pronto = function (options) {
       ...
       function _doRender(e, doPush, mode) {
            ...
            if($('#mnadminbar').length > 0) $('#mnadminbar').html(fn('body').find('#mnadminbar').html()); // Update admmin bar
            ...
            //handle mediaElement
            fn('body').find('video.mn-video-shortcode, audio.mn-audio-shortcode').removeClass().addClass('mn-media-shortcode-ajax');
