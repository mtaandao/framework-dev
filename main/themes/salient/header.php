...
<title> <?php mn_title("|",true, 'right'); ?> <?php if (!defined('MNSEO_VERSION')) { bloginfo('name'); } ?></title>
		...
		<div class="container">
			<nav>
				...
				<?php if(has_nav_menu('secondary_nav')) { ?>
					<ul class="sf-menu">	
				   	   <?php mn_nav_menu( array('walker' => new Nectar_Arrow_Walker_Nav_Menu, 'theme_location' => 'secondary_nav', 'container' => '', 'items_wrap' => '%3$s' ) ); ?>
				    </ul>
				<?php }	?>
					...
					<nav>
						...
						<ul class="sf-menu">	
							...
							if($has_main_menu == 'true') {
							    mn_nav_menu( array('walker' => new Nectar_Arrow_Walker_Nav_Menu, 'theme_location' => 'top_nav', 'container' => '', 'items_wrap' => '%3$s' ) ); 
							} else {
		...
		<ul>
			<?php 
				if($has_main_menu == 'true' && $mobile_fixed == 'false') {
				    ...
				    mn_nav_menu( array('theme_location' => 'top_nav', 'menu' => 'Top Navigation Menu', 'container' => '', 'items_wrap' => '%3$s' ) ); 
