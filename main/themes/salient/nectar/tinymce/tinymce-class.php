...
function enqueue_generator_scripts(){
	...
	mn_enqueue_style('tinymce',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/css/tinymce.css'); 
	mn_enqueue_style('chosen',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/css/chosen/chosen.css'); 
	mn_enqueue_style('simple-slider',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/css/simple_slider/simple-slider.css'); 
	mn_enqueue_style('simple-slider-volume',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/css/simple_slider/simple-slider-volume.css'); 
	
	mn_enqueue_style('font-awesome',get_template_directory_uri() . '/css/font-awesome.min.css'); 
	mn_enqueue_style('steadysets', get_template_directory_uri() . '/css/steadysets.css');
	mn_enqueue_style('linecon', get_template_directory_uri() . '/css/linecon.css');
	mn_enqueue_style('linea', get_template_directory_uri() . '/css/fonts/svg/font/style.css');
		 
	mn_enqueue_script('chosen',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/js/chosen/chosen.jquery.min.js','jquery','1.0 ', TRUE);
	mn_enqueue_script('simple-slider',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/js/simple_slider/simple-slider.min.js','jquery','1.0 ', TRUE);
	
	mn_enqueue_style('magnific',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/css/magnific-popup.css'); 
	mn_enqueue_script('magnific',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/js/magnific-popup.js','jquery','0.9.7 ', TRUE);
	
	mn_enqueue_script('nectar-shortcode-generator-popup',get_template_directory_uri() . '/nectar/tinymce/shortcode_generator/js/popup.js','jquery','0.9.7 ', TRUE);
	mn_enqueue_script('nectar-shortcode-generator',get_template_directory_uri() . '/nectar/tinymce/nectar-shortcode-generator.js','jquery','0.9.7 ', TRUE);
...
$nectar_shortcodes['video'] = array(  
	...
	'attr'=>array( 
	    'mp4'=>array('type'=>'text', 'title'=>__('MP4 File URL', NECTAR_THEME_NAME), 'desc' => __('Only supply the formats you desire, this shortcode is just a shortcut to place the <a href="https://codex.mtaandao.org/Video_Shortcode" target="_blank">default Mtaandao video player</a>.')),
	...
	case 'custom':
		...
		elseif( $name == 'color'){
			...
			if(get_bloginfo('version') >= '3.5') {
	           ...
	           $option_element .='You\'re using an outdated version of Mtaandao. Please update to use this feature.';
	        }	
