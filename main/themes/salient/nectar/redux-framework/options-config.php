<?php
    ...
    $args = array(
        ...
        // For a full list of options, visit: http://codex.mtaandao.org/Function_Reference/add_submenu_page#Parameters
    ...
    $args['share_icons'][] = array(
        'url'   => 'https://www.facebook.com/Mtaandao-488077244574702/?fref=ts',
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'subtitle' => __('This will allow all image links to open in a lightbox - including the images links within standard Mtaandao galleries.', NECTAR_THEME_NAME),
                'desc' => '',
                'switch' => true,
                'default' => '0' 
            ),
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'subtitle' => __('Turning this on will allow your header to take on the background & text colors of the row that it passes. (Ideal for one page sites) <br/> <br/>  See <a href="https://www.youtube.com/user/Mtaandao">tutorial</a> for full example and details', NECTAR_THEME_NAME),
                'desc' => '',
                'switch' => true,
                'required' => array( 'transparent-header', '=', '1' ),
                'default' => '0' 
