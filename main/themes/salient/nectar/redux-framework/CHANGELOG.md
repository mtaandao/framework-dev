...
## 3.5.8.10
* Fixed:    #2726 - Redux fixes for Mtaandao 4.4.
* Fixed:    #2713 - Alerts wouldn't disappear.

## 3.5.8.9
* Fixed:    #2726 - MN 4.4 breaking template.php include, because the core MN guys thought it would be hilarious to break everyone else's stuff.

## 3.5.8.8
* Fixed:    Specifying 'user' in a field's data argument would produce Mtaandao depreciation errors.
...
## 3.5.8.5
* Fixed:    #2684 - Sorter not displaying (or saving) Mtaandao data when using the data argument.

## 3.5.8.4
* Added:    #2673 - MN_CLI check before welcome page redirect.
* Fixed:    #2677 - tinymce javascript errors when mn editor is disabled.
...
* Added:    #2660 - Added 'user'/'users' data type to mtaandao data arg.  Thanks @golchha21.
...
## 3.5.7.5
* Fixed:    Fixing more inconsistencies with mn_filesystem dirlist.  How about some proper documentation, Otto?
...
* Fixed:    #2570 - multi-text field CSS bleeding over into MN.
...
## 3.5.6
* Fixed     Customizer MN 4.3 final fixes.
...
## 3.5.4.35
* Added:    Lite support for https://mtaandao.org/plugins/plugin-dependencies/
...
## 3.5.4.30
* Modified: Dissmissable Redux Admin notices now use the MN 4.2 dismiss JS and Ajax. Pretty.
...
## 3.5.4.19
* Fixed:    #2377 - Replaced mysql_gets_server_info with $mndb.
...
## 3.5.4.14
* Fixed:    #2351 - MN_Error check added to admin blast remote get.

## 3.5.4.13
* Modified: Moved styling for the divide field into it's own CSS file.
* Modified: All MN Color Pickers to properly save the value before save.
...
## 3.4.4.7
* Added:    Redux Framework News Widget on the MN Dashboard.
...
## 3.4.2.5
* Added:   #2031 - Proper CSS sanitization for compliancy with MN.org. 
...
## 3.3.9.3
* Fixed:    #1789 - Customizer now properly working again with MN 4.0. Odd bug.
...
## 3.3.9
* Fixed:    #1775 - Call to undefined function is_customize_preview() in pre MN 4.0.
...
* Modified    #1644 - `import_icon` argument now accepts mtaandao dashicons
...
## 3.2.9.25 
* Fixed:      Update check only appears once if multiple instances of Redux are loaded in the same mtaandao instance.
...
* Issue #140: Admin notice glitch. See http://reduxframework.com/2013/10/mtaandao-notifications-custom-options-panels/
