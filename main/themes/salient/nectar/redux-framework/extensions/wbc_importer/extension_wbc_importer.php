...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        public function __construct( $parent ) {
            ...
            add_action( 'mn_ajax_redux_wbc_importer', array(
                    $this,
                    'ajax_importer'
                ) );
        ...
        public function addImportFiles( $wbc_import_files ) {
            ...
            $wbc_import_files = mn_parse_args( $wbc_import_files, $this->wbc_import_files );

            return $wbc_import_files;
        }

        public function ajax_importer() {
            if ( !isset( $_REQUEST['nonce'] ) || !mn_verify_nonce( $_REQUEST['nonce'], "redux_{$this->parent->args['opt_name']}_wbc_importer" ) ) {
                die( 0 );
            }
        ...
        function add_importer_section() {
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Works best to import on a new install of Mtaandao. If you\'re not using a fresh install, make sure you backup your current theme options as they will be overwritten.', 'framework' ) ).'</p>',
