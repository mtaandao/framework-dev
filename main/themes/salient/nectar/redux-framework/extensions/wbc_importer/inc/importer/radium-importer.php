...
if ( !class_exists( 'Radium_Theme_Importer' ) ) {
  ...
  class Radium_Theme_Importer {
    ...
    public function __construct() {
      ...
      add_action( 'import_end', array( $this, 'after_mn_importer' ) );
    ...
    /**
     * Avoids adding duplicate meta causing arrays in arrays from MN_importer
     *
     * @param null    $continue
    ...
    public function after_mn_importer() {
