    ...
    $.redux.initEvents = function() {
        ...
        $( '#toplevel_page_' + redux.args.slug + ' .mn-submenu a, #admin-bar-' + redux.args.slug + ' a.ab-item' ).click(
            function( e ) {
                ...
                if ( ( $( '#toplevel_page_' + redux.args.slug ).hasClass( 'mn-menu-open' ) || $( this ).hasClass( 'ab-item' ) ) && !$( this ).parents( 'ul.ab-submenu:first' ).hasClass( 'ab-sub-secondary' ) && $( this ).attr( 'href' ).toLowerCase().indexOf( redux.args.slug + "&tab=" ) >= 0 ) {
                    e.preventDefault();
