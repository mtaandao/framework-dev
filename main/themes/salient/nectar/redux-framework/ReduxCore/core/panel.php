    ...
    if ( ! class_exists( 'reduxCorePanel' ) ) {
        ...
        class reduxCorePanel {
            ...
            private function panel_template() {
                ...
                // Security is vital!
                echo '<input type="hidden" id="ajaxsecurity" name="security" value="' . mn_create_nonce( 'redux_ajax_nonce' . $this->parent->args['opt_name'] ) . '" />';
            ...
            /**
             * Outputs the HTML for a given section using the Mtaandao settings API.
             *
