<?php
    ...
    class Redux_P {
        ...
        public function proxy() {
            ...
            if ( ! isset( $_GET['nonce'] ) || ( isset( $_GET['nonce'] ) && ! mn_verify_nonce( $_GET['nonce'], "redux-ads-nonce" ) ) ) {
                die();
            }
...
// ############################################################################
            ...
            if ( isset( $_GET['mode'] ) && $_GET['mode'] == 'native' ) {
                ...
                if ( ! is_mn_error( $response ) && isset( $response['headers']['content-type'] ) ) {
                    header( 'Content-Type: ' . $response['headers']['content-type'] );
                }
                if ( ! is_mn_error( $response ) && isset( $response['headers']['content-language'] ) ) {
                    header( 'Content-Language: ' . $response['headers']['content-language'] );
                }
                if ( ! is_mn_error( $response ) && isset( $response['headers']['set-cookie'] ) ) {
