        ...
        class ReduxFramework_background {
            ...
            public function enqueue() {
                if ( function_exists( 'mn_enqueue_media' ) ) {
                    ...
                    if (!mn_script_is ( 'media-upload' )) {
                        mn_enqueue_script( 'media-upload' );
                    }
                }
                
                if (!mn_style_is ( 'select2-css' )) {
                    mn_enqueue_style( 'select2-css' );
                }
                
                if (!mn_style_is ( 'mn-color-picker' )) {
                    mn_enqueue_style( 'mn-color-picker' );
                }
                
                if (!mn_script_is ( 'redux-field-background-js' )) {
                    mn_enqueue_script(
                ...
                if ($this->parent->args['dev_mode']) {
                    if (!mn_style_is ( 'redux-field-background-css' )) {
                        mn_enqueue_style(
                    ...
                    if (!mn_style_is ( 'redux-color-picker-css' )) {
                        mn_enqueue_style( 'redux-color-picker-css' );
                    }
                }
            }
