...
//				+ '</div>' ).appendTo( $control.parents( '.mn-picker-container:first' ).addClass( 'vc_color-picker' ).find( '.iris-picker' ) );
//				$alpha = $control.parents( '.mn-picker-container:first' ).find( '.vc_alpha-field' );
//                                //console.log($alpha);
//				$alpha_output = $control.parents( '.mn-picker-container:first' ).find( '.redux-alpha-container output' );
//				$alpha.bind( 'change keyup', function () {
//					var alpha_val = parseFloat( $alpha.val() ),
//						iris = $control.data( 'a8cIris' ),
//						color_picker = $control.data( 'mn-mnColorPicker' );
...
//                                        el.find( '.redux-color-init' ).mnColorPicker( 'color', iris._color.toString() );
