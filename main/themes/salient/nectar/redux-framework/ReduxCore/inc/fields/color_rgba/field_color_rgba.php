    ...
    class ReduxFramework_color_rgba {
       ...
       */
        ...
        public function enqueue() {
            ...
            // Field dependent JS
            if (!mn_script_is ( 'redux-field-color-rgba-js' )) {
                mn_enqueue_script(
            ...
            // Spectrum CSS
            if (!mn_style_is ( 'redux-spectrum-css' )) {
                mn_enqueue_style('redux-spectrum-css');
            }
            
            if ($this->parent->args['dev_mode']) {
                if (!mn_style_is ( 'redux-field-color-rgba-css' )) {
                    mn_enqueue_style(
