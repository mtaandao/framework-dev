        ...
        class Redux_ThemeCheck {
            ...
            public function enqueue_admin_styles() {
                ...
                if ( 'appearance_page_themecheck' == $screen->id ) {
                    mn_enqueue_style( $this->slug . '-admin-styles', ReduxFramework::$_url . 'inc/themecheck/css/admin.css', array(), $this->version );
                }
            }
            ...
            public function enqueue_admin_scripts() {
                ...
                if ( 'appearance_page_themecheck' == $screen->id ) {
                    mn_enqueue_script( $this->slug . '-admin-script', ReduxFramework::$_url . 'inc/themecheck/js/admin.js', array( 'jquery' ), $this->version );
                    ...
                    if ( ! isset( $_POST['themename'] ) ) {
                        ...
                        mn_localize_script( $this->slug . '-admin-script', 'redux_check_intro', $redux_check_intro );
