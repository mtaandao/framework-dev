<?php
     ...
     */
    class Redux_Customizer_Section extends MN_Customize_Section {
         ...
         * export custom variables by overriding {@see MN_Customize_Section::json()}.
         *
