    ...
    if ( ! class_exists( 'ReduxFramework_extension_import_export' ) ) {
        ...
        class ReduxFramework_extension_import_export {
            ...
            public function __construct( $parent ) {
                ...
                add_action( "mn_ajax_redux_link_options-" . $this->parent->args['opt_name'], array(
                    $this,
                    "link_options"
                ) );
                add_action( "mn_ajax_nopriv_redux_link_options-" . $this->parent->args['opt_name'], array(
                    $this,
                    "link_options"
                ) );

                add_action( "mn_ajax_redux_download_options-" . $this->parent->args['opt_name'], array(
                    $this,
                    "download_options"
                ) );
                add_action( "mn_ajax_nopriv_redux_download_options-" . $this->parent->args['opt_name'], array(
                    $this,
                    "download_options"
                ) );
            ...
            /**
             * Adds the appropriate mime types to Mtaandao
             *
