                                ...
                                setup = function() {
                                    ...
                                    jQuery( '#pointer-close' ).click(
                                        function() {
                                            ...
                                            //redux_setIgnore("tour", "mn-pointer-0", "<?php echo esc_js(mn_create_nonce('redux-ignore')); ?>");
                                            <?php } else { ?>
