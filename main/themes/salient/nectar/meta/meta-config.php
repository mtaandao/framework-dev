...
function nectar_create_meta_box( $post, $meta_box )
{
	...
	mn_nonce_field( basename(__FILE__), 'nectar_meta_box_nonce' );
	...
	foreach( $meta_box['fields'] as $field ){
		...
		switch( $field['type'] ){	
			...
			case 'editor' :
		        ...
		        mn_editor($meta, $field['id'], $settings );
			...
			case 'choice_below' :
				...
				mn_register_style(
				 ...
				 mn_enqueue_style('redux-opts-jquery-ui-custom-css');
		         mn_enqueue_script(
...
function nectar_save_meta_box( $post_id ) {
	...
	if ( !isset($_POST['nectar_meta']) || !isset($_POST['nectar_meta_box_nonce']) || !mn_verify_nonce( $_POST['nectar_meta_box_nonce'], basename( __FILE__ ) ) )
		return;
