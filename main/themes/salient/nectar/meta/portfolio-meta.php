...
function nectar_metabox_portfolio(){
	...
	$results = $mndb->get_results("SELECT * FROM $mndb->posts
		...
		if($post) {
			...
			if(!empty($using_gallery_slider) && $using_gallery_slider == 'on'){
				$gallery_slider = array(
						...
						'desc' => __('This will turn all default Mtaandao galleries attached to this post into a simple slider.', NECTAR_THEME_NAME),
