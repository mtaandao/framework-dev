    ...
    $meta_box = array(
		...
		'fields' => array(
			...
			array( 
					...
					'desc' => __('Enter in an embed code from Youtube or Vimeo that will be used to display your video in a popup. (You can also use the Mtaandao video shortcode)', NECTAR_THEME_NAME),
