	...
	function nectar_metabox_posts(){
		...
		if ( floatval(get_bloginfo('version')) < "3.6" ) { 
			...
			$meta_box = array(
				...
				'description' => 'Once you\'ve inserted a Mtaandao gallery using the "Add Media" button above, you can use the gallery slider checkbox below to transform your images into a slider.',
				'post_type' => 'post',
				'context' => 'normal',
				'priority' => 'high',
				'fields' => array(
		...
		$meta_box = array(
			...
			'fields' => array(
				array(
						...
						'desc' => __('Please input the URL for your link. I.e. http://www.mtaandao.co.ke', NECTAR_THEME_NAME),
						'id' => '_nectar_link',
						'type' => 'text',
						'std' => ''
					)
