 ...
 * Plugin URI: https://github.com/kucrut/mn-menu-item-custom-fields
...
if ( ! class_exists( 'Menu_Item_Custom_Fields' ) ) :
	...
	*/
	class Menu_Item_Custom_Fields {
		...
		*/
		public static function load() {
			add_filter( 'mn_edit_nav_menu_walker', array( __CLASS__, '_filter_walker' ), 99 );
		}
		/**
	...
	add_action( 'mn_loaded', array( 'Menu_Item_Custom_Fields', 'load' ), 9 );
