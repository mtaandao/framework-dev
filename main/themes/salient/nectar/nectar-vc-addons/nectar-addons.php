...
global $options;
$vc_is_mn_version_3_6_more = version_compare(preg_replace('/^([\d\.]+)(\-.*$)/', '$1', get_bloginfo('version')), '3.6') >= 0;
...
vc_remove_element("vc_mn_archives");
vc_remove_element("vc_mn_calendar");
vc_remove_element("vc_mn_categories");
vc_remove_element("vc_mn_custommenu");
vc_remove_element("vc_mn_links");
vc_remove_element("vc_mn_meta");
vc_remove_element("vc_mn_pages");
vc_remove_element("vc_mn_posts");
vc_remove_element("vc_mn_recentcomments");
vc_remove_element("vc_mn_rss");
vc_remove_element("vc_mn_search");
vc_remove_element("vc_mn_tagcloud");
vc_remove_element("vc_mn_text");
...
function dropdown_multi_settings_field( $param, $value ) {
	 ...
	 $param_line = '';
	 $param_line .= '<select multiple name="'. esc_attr( $param['param_name'] ).'" class="mnb_vc_param_value mnb-input mnb-select '. esc_attr( $param['param_name'] ).' '. esc_attr($param['type']).'">';
...
function fws_image_settings_field( $param, $value ) {
		$param_line = '';
		$param_line .= '<input type="hidden" class="mnb_vc_param_value gallery_widget_attached_images_ids '.esc_attr($param['param_name']).' '.esc_attr($param['type']).'" name="'.esc_attr($param['param_name']).'" value="'.esc_attr($value).'"/>';
        ...
        //$param_line .= '<div class="mnb_clear"></div>';
...
if(function_exists('vc_add_shortcode_param')) {
	...
	function hotspot_image_preview_field( $settings, $value ) {
	   ...
	   return '<div id="nectar_image_with_hotspots_preview"><input name="' . esc_attr( $settings['param_name'] ) . '" type="hidden" class="mnb_vc_param_value ' . esc_attr( $settings['param_name'] ) . '" value="'.$value.'" /> '.$image_output. '</div>'; 
	}
}
...
function nectar_custom_maps() {
	...
	class MNBakeryShortCode_Full_Width_Section extends MNBakeryShortCode_VC_Row {
		...
		public function contentAdmin($atts, $content = null) {
	        ...
	        for ( $i=0; $i < count($width); $i++ ) {
	            $output .= '<div'.$this->customAdminBockParams().' data-element_type="vc_row" class="'.$this->settings['base'].' mnb_vc_row mnb_sortable">';
	            $output .= str_replace("%column_size%", 1, $column_controls);
	            $output .= '<div class="mnb_element_wrapper">';
	            $output .= '<div class="vc_row-fluid vc_row mnb_row_container vc_container_for_children">';
	...
	if(nectar_has_shortcode('nectar_slider')) { 
		...
		vc_map( array(
		  ...
		  "base" => "nectar_slider",
		  "icon" => "icon-mnb-nectar-slider",
		  "category" => __('Nectar Elements', 'js_composer'),
		  "description" => __('The jaw-dropping slider by Mtaandao', 'js_composer'),
		  "weight" => 10,
		  "params" => array(
		    array(
		      "type" => "dropdown",
	...
	// Split Line Heading
	class MNBakeryShortCode_Split_Line_Heading extends MNBakeryShortCode { }
	vc_map( array(
			"name" => "Split Line Heading",
			"base" => "split_line_heading",
			"icon" => "icon-mnb-split-line-heading",
			"allowed_container_element" => 'vc_row',
			"category" => __('Nectar Elements', 'js_composer'),
	...
	//cascading images
class MNBakeryShortCode_Nectar_Cascading_Images extends MNBakeryShortCode {}
	...
	// Image Comparision
	class MNBakeryShortCode_Nectar_Image_Comparison extends MNBakeryShortCode {}
	...
	if($woocommerce) {
		...
		class MNBakeryShortCode_Nectar_Woo_Products extends MNBakeryShortCode {
	...
	vc_map( array(
	  ...
	  "base" => "heading",
	  "icon" => "icon-mnb-centered-heading",
	  "category" => __('Nectar Elements', 'js_composer'),
	...
	// video lightbox
	class MNBakeryShortCode_Nectar_Video_Lightbox extends MNBakeryShortCode {}
	vc_map( array(
	  "name" => __("Video Lightbox", "js_composer"),
	  "base" => "nectar_video_lightbox",
	  "icon" => "icon-mnb-video-lightbox",
	  "category" => __('Nectar Elements', 'js_composer'),
	  ...
	  "params" => array(
		...
		// Google Map
		class MNBakeryShortCode_Nectar_Gmap extends MNBakeryShortCode {
		}
	...
	// Fancy Box
	class MNBakeryShortCode_Fancy_Box extends MNBakeryShortCode { }
		vc_map( array(
		  "name" => __("Fancy Box", "js_composer"),
		  "base" => "fancy_box",
		  "icon" => "icon-mnb-fancy-box",
		  "category" => __('Nectar Elements', 'js_composer'),
	...
	// Flip Box
	class MNBakeryShortCode_Nectar_Flip_Box extends MNBakeryShortCode { }
		vc_map( array(
		  "name" => __("Flip Box", "js_composer"),
		  "base" => "nectar_flip_box",
		  "icon" => "icon-mnb-nectar-flip-box",
		  "category" => __('Nectar Elements', 'js_composer'),
	...
	// Gradient Text
	class MNBakeryShortCode_Nectar_Gradient_Text extends MNBakeryShortCode { }
		vc_map( array(
		  "name" => __("Gradient Text", "js_composer"),
		  "base" => "nectar_gradient_text",
		  "icon" => "icon-mnb-nectar-gradient-text",
		  "category" => __('Nectar Elements', 'js_composer'),
	...
	// Hotspot
	class MNBakeryShortCode_Nectar_Image_With_Hotspots extends MNBakeryShortCode { }
		...
		class MNBakeryShortCode_Nectar_Hotspot extends MNBakeryShortCode { }
	...
	// Fancy Title
	class MNBakeryShortCode_Nectar_Animated_Title extends MNBakeryShortCode { }
		vc_map( array(
	...
	vc_map( array(
	  ...
	  "custom_markup" => '
	  <div class="mnb_accordion_holder mnb_holder clearfix vc_container_for_children">
	  %content%
	  </div>
	...
	vc_map( array(
	  ...
	  "custom_markup" => '
	  <div class="mnb_tabs_holder mnb_holder vc_container_for_children">
	  ...
	  ',
	  "js_view" => ($vc_is_mn_version_3_6_more ? 'VcTabsView' : 'VcTabsView35')
	));
	...
	vc_map( array(
	  ...
	  'js_view' => ($vc_is_mn_version_3_6_more ? 'VcTabView' : 'VcTabView35')
	));




	class MNBakeryShortCode_Testimonial_Slider extends MNBakeryShortCode_Tabbed_Section { }
	...
	vc_map( array(
	  ...
	  "show_settings_on_create" => false,
	  "is_container" => true,
	  "icon" => "icon-mnb-testimonial-slider",
	  "category" => __('Nectar Elements', 'js_composer'),
	...
	/* clients slider */
	class MNBakeryShortCode_Clients extends MNBakeryShortCode_Tabbed_Section { }
	...
	class MNBakeryShortCode_Client extends MNBakeryShortCode {
	...
	/* icon list */
	class MNBakeryShortCode_Nectar_Icon_List extends MNBakeryShortCode_Tabbed_Section { }
	...
	class MNBakeryShortCode_Nectar_Icon_List_Item extends MNBakeryShortCode {
	...
	/* page sub menu */
	class MNBakeryShortCode_Page_Submenu extends MNBakeryShortCode_Tabbed_Section { }
	...
	class MNBakeryShortCode_Page_Link extends MNBakeryShortCode {
	...
	/* pricing table */
	class MNBakeryShortCode_Pricing_Table extends MNBakeryShortCode_Tabbed_Section { }
	...
	class MNBakeryShortCode_Pricing_Column extends MNBakeryShortCode {
	...
	/* carousel */
	class MNBakeryShortCode_Carousel extends MNBakeryShortCode_Tabbed_Section { }
	...
	if(nectar_has_shortcode('vc_gallery')) { 
		...
		vc_add_param("vc_gallery",array(
		      ...
		      "param_name" => "img_size",
		      "description" => __("Enter image size in pixels - e.g 600x400 (Width x Height) <br/> Or use Mtaandao image size names such as \"full\"", "js_composer"),
		      "dependency" => Array('element' => "source", 'value' => array('media_library'))
		));
	...
	// Morphing Outline
	class MNBakeryShortCode_Morphing_Outline extends MNBakeryShortCode { }
	vc_map( array(
			"name" => "Morphing Outline",
			"base" => "morphing_outline",
			"icon" => "icon-mnb-morphing-outline",
			"allowed_container_element" => 'vc_row',
			"category" => __('Nectar Elements', 'js_composer'),
	...
	class MNBakeryShortCode_Nectar_Btn extends MNBakeryShortCode { }
