<?php
   ...
   extract(shortcode_atts(array(
    ...
    echo'
	<div id="'.$row_id.'" data-midnight="'.strtolower($text_color).'" data-bg-mobile-hidden="'.$background_image_mobile_hidden.'" class="mnb_row vc_row-fluid vc_row '. $main_class . $equal_height_class . $parallax_class . ' ' . $vertically_center_class . ' '. $class . ' " '.$using_custom_text_color.' style="'.$style.'">';
