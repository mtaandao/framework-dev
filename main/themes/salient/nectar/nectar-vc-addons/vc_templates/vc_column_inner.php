...
$width = mnb_translateColumnWidthToSpan($width);
$width = vc_column_offset_class_merge($offset, $width);
$box_border = null;
$parsed_animation = null;	
$style = 'style="';

$el_class .= ' mnb_column column_container vc_column_container col';
...
if(!empty($background_image)) {
	...
	$bg_image_src = mn_get_attachment_image_src($background_image, 'full');
