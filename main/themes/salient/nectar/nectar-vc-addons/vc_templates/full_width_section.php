   ...
   extract(shortcode_atts(array(
	...
	if(!empty($image_url)) {
		...
		if(!preg_match('/^\d+$/',$image_url)){
			...
			$bg_image_src = mn_get_attachment_image_src($image_url, 'full');
    ...
    echo'<div id="'.uniqid("fws_").'" class="mnb_row vc_row-fluid '. $main_class . $parallax_class . ' ' . $vertically_center_class . ' ' . $class . ' " '.$using_custom_text_color.' style="'.$style.'">';
