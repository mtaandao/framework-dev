<?php
   ...
   extract(shortcode_atts(array(
	...
	mn_enqueue_script('nectarMap', get_template_directory_uri() . '/js/map.js', array('jquery'), '7.0.7', TRUE);
	...
	if(!empty($marker_image)) {
		$marker_image_src = mn_get_attachment_image_src($marker_image, 'full');
