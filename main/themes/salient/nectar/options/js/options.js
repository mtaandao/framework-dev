...
jQuery(document).ready(function () {
    ...
    jQuery('.redux-opts-group-tab').each(function(){
	    ...
	    jQuery(this).find('input.five-columns').parents('.mn-picker-container').unwrap();
	  
	    ////update desc
	    jQuery(this).find('input.five-columns').parents('.mn-picker-container').each(function(i){
	  	...
	  	jQuery(this).find('input.five-columns').parents('.mn-picker-container').wrapAll('<td colspan="2">'); 	
