...
$path_to_file = explode( 'main', $absolute_path );
$path_to_mn = $path_to_file[0];

require_once( $path_to_mn . '/mn-load.php' );
...
mn_dequeue_script( 'my_acsearch' );  
mn_dequeue_script( 'respond' ); 
