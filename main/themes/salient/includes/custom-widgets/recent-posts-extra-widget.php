...
class Recent_Posts_Extra_Widget extends MN_Widget {
	...
	function widget($args, $instance) {
		$cache = mn_cache_get('recent_posts_extra_widget', 'widget');
		...
		$r = new MN_Query(array('shomnosts' => $number, 'nopaging' => 0, 'post_status' => 'publish'));
		if ($r->have_posts()) :
?>
...
<?php
		...
		mn_cache_add('recent_posts_extra_widget', $cache, 'widget');
	}
	...
	function flush_widget_cache() {
		mn_cache_delete('recent_posts_extra_widget', 'widget');
	}
