...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://mtaandao.github.io/Appearance_Widgets_Screen">Documentation on Widgets</a>') . '</p>' .
	'<p>' . __('<a href="https://mtaandao.co.ke/support/">Support Forums</a>') . '</p>'
);

if ( ! current_theme_supports( 'widgets' ) ) {
	mn_die( __( 'The theme you are currently using isn&#8217;t widget-aware, meaning that it has no sidebars that you are able to change. For information on making your theme widget-aware, please <a href="https://mtaandao.github.io/Widgetizing_Themes">follow these instructions</a>.' ) );
}
