...
if ( current_user_can( 'install_themes' ) ) {
	if ( is_multisite() ) {
		...
		$help_install = '<p>' . sprintf( __('If you would like to see more themes to choose from, click on the &#8220;Add New&#8221; button and you will be able to browse or search for additional themes from the <a href="%s">Mtaandao Theme Directory</a>. Themes in the Mtaandao Theme Directory are designed and developed by third parties, and are compatible with the license Mtaandao uses. Oh, and they&#8217;re free!'), __( 'https://themes.mtaandao.co.ke/' ) ) . '</p>';
	}
	...
	if ( is_array( $submenu ) && isset( $submenu['themes.php'] ) ) {
		foreach ( (array) $submenu['themes.php'] as $item) {
			...
			if ( !empty($submenu[$item[2]]) ) {
				...
				if ( file_exists(PLUGIN_DIR . "/{$submenu[$item[2]][0][2]}") || !empty($menu_hook))
