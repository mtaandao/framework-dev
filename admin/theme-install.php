...
$help_overview =
	'<p>' . sprintf(
			...
			__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">Mtaandao Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license Mtaandao uses.' ),
			__( 'https://themes.mtaandao.co.ke/' )
		) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://mtaandao.github.io/Using_Themes#Adding_New_Themes">Documentation on Adding New Themes</a>') . '</p>' .
...
<div class="wrap">
	...
	<div class="mn-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on Mtaandao.org, you can browse them here.' ); ?></p>

			<p>
				<label for="mnorg-username-input"><?php _e( 'Your Mtaandao.org username:' ); ?></label>
