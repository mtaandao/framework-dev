...
$profile_help = '<p>' . __('Your profile contains information about you (your &#8220;account&#8221;) as well as some personal options related to using Mtaandao.') . '</p>' .
	...
	'<p>' . __( 'You can select the language you wish to use while using the Mtaandao administration screen without affecting the language site visitors see.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://mtaandao.github.io/Users_Your_Profile_Screen">Documentation on User Profiles</a>') . '</p>' .
...
<?php endif; ?>
<?php if ( count($_admin_css_colors) > 1 && has_action('admin_color_scheme_picker') ) : ?>
...
<?php
endif; // $_admin_css_colors
if ( !( IS_PROFILE_PAGE && !$user_can_edit ) ) : ?>
<tr class="user-comment-shortcuts-wrap">
<th scope="row"><?php _e( 'Keyboard Shortcuts' ); ?></th>
<td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts" id="comment_shortcuts" value="true" <?php if ( ! empty( $profileuser->comment_shortcuts ) ) checked( 'true', $profileuser->comment_shortcuts ); ?> /> <?php _e('Enable keyboard shortcuts for comment moderation.'); ?></label> <?php _e('<a href="https://mtaandao.github.io/Keyboard_Shortcuts" target="_blank">More information</a>'); ?></td>
</tr>
<?php endif; ?>
...
<tr id="password" class="user-pass1-wrap">
	...
	<td>
		...
		<button type="button" class="button mn-generate-pw hide-if-no-js"><?php _e( 'Generate Password' ); ?></button>
		<div class="mn-pwd hide-if-js">
			...
			<button type="button" class="button mn-hide-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password' ); ?>">
				<span class="dashicons dashicons-hidden"></span>
				<span class="text"><?php _e( 'Hide' ); ?></span>
			</button>
			<button type="button" class="button mn-cancel-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Cancel password change' ); ?>">
