...
if ( 'post' == $post_type ) {
	...
	'<p>' . __('<a href="https://mtaandao.github.io/Posts_Screen">Documentation on Managing Posts</a>') . '</p>' .
	...
	get_current_screen()->set_help_sidebar(
	'<p><strong>' . __('For more information:') . '</strong></p>' .
	'<p>' . __('<a href="https://mtaandao.github.io/Pages_Screen">Documentation on Managing Pages</a>') . '</p>' .
	'<p>' . __('<a href="https://mtaandao.co.ke/support/">Support Forums</a>') . '</p>'
	);
