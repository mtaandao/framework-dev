...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://mtaandao.github.io/Users_Add_New_Screen">Documentation on Adding New Users</a>') . '</p>' .
...
<?php if ( !is_multisite() ) { ?>
	...
	<tr class="form-field form-required user-pass1-wrap">
		...
		<td>
			...
			<button type="button" class="button mn-generate-pw hide-if-no-js"><?php _e( 'Show password' ); ?></button>
