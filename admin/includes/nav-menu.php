...
function _mn_ajax_menu_quick_search( $request = array() ) {
	...
	if ( 'get-post-item' == $type ) {
		...
		if ( 'posttype' == $matches[1] && get_post_type_object( $matches[2] ) ) {
			$post_type_obj = _mn_nav_menu_meta_box_object( get_post_type_object( $matches[2] ) );
			$args = array_merge(
				$args,
				array(
					'no_found_rows'          => true,
			...
			$search_results_query = new MN_Query( $args );
	...
	<div class="customlinkdiv" id="customlinkdiv">
		...
		<p class="button-controls mn-clearfix">
			<span class="add-to-menu">
				<input type="submit"<?php mn_nav_menu_disabled_check( $nav_menu_selected_id ); ?> class="button submit-add-to-menu right" value="<?php esc_attr_e('Add to Menu'); ?>" name="add-custom-menu-item" id="submit-customlinkdiv" />
...
function mn_nav_menu_item_post_type_meta_box( $object, $box ) {
	...
	<div id="posttype-<?php echo $post_type_name; ?>" class="posttypediv">
		...
		<p class="button-controls mn-clearfix">
			...
			<span class="add-to-menu">
				<input type="submit"<?php mn_nav_menu_disabled_check( $nav_menu_selected_id ); ?> class="button submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu' ); ?>" name="add-post-type-menu-item" id="<?php echo esc_attr( 'submit-posttype-' . $post_type_name ); ?>" />
				<span class="spinner"></span>
			</span>
		</p>
...
function mn_nav_menu_item_taxonomy_meta_box( $object, $box ) {
	...
	<div id="taxonomy-<?php echo $taxonomy_name; ?>" class="taxonomydiv">
		...
		<p class="button-controls mn-clearfix">
			...
			<span class="add-to-menu">
				<input type="submit"<?php mn_nav_menu_disabled_check( $nav_menu_selected_id ); ?> class="button submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu' ); ?>" name="add-taxonomy-menu-item" id="<?php echo esc_attr( 'submit-taxonomy-' . $taxonomy_name ); ?>" />
				<span class="spinner"></span>
			</span>
		</p>
