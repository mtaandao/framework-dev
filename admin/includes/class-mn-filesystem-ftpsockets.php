<?php
/**
 * Mtaandao FTP Sockets Filesystem.
 *
 * @package Mtaandao
...
/**
 * Mtaandao Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 * @package Mtaandao
 * @subpackage Filesystem
 * @uses MN_Filesystem_Base Extends class
 */
class MN_Filesystem_ftpsockets extends MN_Filesystem_Base {
	/**
	 * @access public
	 * @var ftp
	 */
