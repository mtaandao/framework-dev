...
// Media Hooks.
add_filter( 'mn_handle_upload_prefilter', 'check_upload_size' );
...
// Site Hooks.
add_action( 'mnmueditblogaction', 'upload_space_setting' );

// Taxonomy Hooks
add_filter( 'get_term', 'sync_category_tag_slugs', 10, 2 );

// Post Hooks.
add_filter( 'mn_insert_post_data', 'avoid_blog_page_permalink_collision', 10, 2 );
