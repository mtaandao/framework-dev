...
<div class="tagsdiv" id="<?php echo $tax_name; ?>">
	...
	<div class="ajaxtag hide-if-no-js">
		...
		<p><input data-mn-taxonomy="<?php echo $tax_name; ?>" type="text" id="new-tag-<?php echo $tax_name; ?>" name="newtag[<?php echo $tax_name; ?>]" class="newtag form-input-tip" size="16" autocomplete="off" aria-describedby="new-tag-<?php echo $tax_name; ?>-desc" value="" />
...
<p><?php
	printf(
		...
		__( 'https://mtaandao.github.io/Excerpt' )
	);
?></p>
<?php
}
...
<p><?php
	printf(
		...
		__( 'https://mtaandao.github.io/Introduction_to_Blogging#Managing_Comments' )
	);
?></p>
<?php
if ( ! empty($pings) )
...
<p><?php
	printf(
		...
		__( 'https://mtaandao.github.io/Using_Custom_Fields' )
	);
?></p>
<?php
}
