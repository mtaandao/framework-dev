...
( function( api, mn, $ ) {
	...
	api.Menus.insertAutoDraftPost = function insertAutoDraftPost( params ) {
		...
		request = mn.ajax.post( 'customize-nav-menus-insert-auto-draft', {
	...
	api.Menus.AvailableMenuItemsPanelView = mn.Backbone.View.extend({
		...
		submitNew: function( container ) {
			...
			promise.done( function( data ) {
				...
				itemElement = $( mn.template( 'available-menu-item' )( availableItem.attributes ) );
	...
	api.Menus.MenuSection = api.Section.extend({
		...
		onChangeExpanded: function( expanded, args ) {
			...
			if ( expanded ) {
				mnNavMenu.menuList = section.contentContainer;
	...
	api.Menus.NewMenuSection = api.Section.extend({
		...
		onChangeExpanded: function( expanded ) {
			var section = this,
				...
				customizer = section.headContainer.closest( '.mn-full-overlay-sidebar-content' );
			if ( expanded ) {
