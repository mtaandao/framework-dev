...
jQuery( document ).ready( function( $ ) {
	 ...
	 * @todo Consider to implement a Mtaandao general utility for this and don't use jQuery UI.
	 */
	function handleTabbables() {
		...
		$firstAndLast.off( 'keydown.mn-plugin-details' );
		// Attach again the keydown event on the first and last focusable elements.
		$firstAndLast.on( 'keydown.mn-plugin-details', function( event ) {
