...
jQuery(window).unload( function () { tinymce = tinyMCE = mngallery = null; } ); // Cleanup

/* gallery settings */
var tinymce = null, tinyMCE, mngallery;
...
mngallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName !== 'IMG' || ! ed.dom.hasClass(t.el, 'mnGallery') ) {
			if ( ( g = ed.dom.select('img.mnGallery') ) && g[0] ) {
				t.el = g[0];
			} else {
