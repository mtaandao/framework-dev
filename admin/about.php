...
?>
	<div class="wrap about-wrap">
		...
		<div class="feature-section one-col">
			...
			<p class="lead-description"><?php _e( 'Mtaandao 4.7 adds new features to the customizer to help take you through the initial setup of a theme, with non-destructive live previews of all your changes in one uninterrupted workflow.' ); ?></p>
		</div>
		...
		<div class="feature-section two-col">
			...
			<div class="col">
				...
				echo mn_video_shortcode( array(
					...
					'width'    => 1140,
					'height'   => 624,
					// 'class'    => 'mn-video-shortcode feature-video',
				) );
				?>
			</div>
		</div>
		...
		<div class="feature-section two-col">
			...
			<div class="col">
				...
				<p><?php _e( 'Sometimes you just need a few visual tweaks to make your site perfect. Mtaandao 4.7 allows you to add custom CSS and instantly see how your changes affect your site. The live preview allows you to work quickly without page refreshes slowing you down.' ); ?></p>
			</div>
		</div>
		...
		<div class="feature-section no-heading two-col">
			<div class="col">
				...
				<p><?php _e( 'Managing your document collection is easier with Mtaandao 4.7. Uploading PDFs will generate thumbnail images so you can more easily distinguish between all your documents.' ); ?></p>
			</div>
			<div class="col">
		...
		<div class="rest-api feature-section one-col">
			...
			<p class="lead-description"><?php _e( 'Mtaandao 4.7 comes with REST API endpoints for posts, comments, terms, users, meta, and settings.' ); ?></p>
			...
			<p><?php
				printf(
					/* translators: %s: https://developer.mtaandao.co.ke/rest-api/  */
					__( 'Content endpoints provide machine-readable external access to your Mtaandao site with a clear, standards-driven interface, paving the way for new and innovative methods of interacting with sites through plugins, themes, apps, and beyond. Ready to get started with development? <a href="%s">Check out the REST API reference.</a>' ),
					'https://developer.mtaandao.co.ke/rest-api/reference/'
				);
			?></p>
		</div>
		...
		<div class="changelog">
			...
			<div class="under-the-hood three-col">
				<div class="col">
					<h3><a href="https://make.mtaandao.co.ke/core/2016/11/03/post-type-templates-in-4-7/"><?php _e( 'Post Type Templates' ); ?></a></h3>
					<p><?php _e( 'By opening up the page template functionality to all post types, theme developers have even more flexibility with the Mtaandao template hierarchy.' ); ?></p>
				</div>
				<div class="col">
					<h3><?php _e( 'More Theme API Goodies' ); ?></h3>
					<p><?php
						printf(
							/* translators: %s: https://make.mtaandao.co.ke/core/2016/09/09/new-functions-hooks-and-behaviour-for-theme-developers-in-mtaandao-4-7/  */
							__( 'Mtaandao 4.7 includes <a href="%s">new functions, hooks, and behavior</a> for theme developers.' ),
							'https://make.mtaandao.co.ke/core/2016/09/09/new-functions-hooks-and-behaviour-for-theme-developers-in-mtaandao-4-7/'
						);
					?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.mtaandao.co.ke/core/2016/10/04/custom-bulk-actions/"><?php _e( 'Custom Bulk Actions' ); ?></a></h3>
			...
			<div class="under-the-hood three-col">
				<div class="col">
					<h3><a href="https://make.mtaandao.co.ke/core/2016/09/08/mn_hook-next-generation-actions-and-filters/"><code>MN_Hook</code></a></h3>
					<p><?php
						printf(
							/* translators: %s: https://make.mtaandao.co.ke/core/2016/09/08/mn_hook-next-generation-actions-and-filters/  */
							__( 'The code that lies beneath actions and filters has been overhauled and modernized, fixing bugs along the way.' ),
							'https://make.mtaandao.co.ke/core/2016/09/08/mn_hook-next-generation-actions-and-filters/'
						);
					?></p>
				</div>
				<div class="col">
					...
					<p><?php
						printf(
							/* translators: 1: register_setting(), 2: https://make.mtaandao.co.ke/core/2016/10/26/registering-your-settings-in-mtaandao-4-7/ */
							__( '%1$s <a href="%2$s">has been enhanced</a> to include type, description, and REST API visibility.' ),
							'<code>register_setting()</code>',
							'https://make.mtaandao.co.ke/core/2016/10/26/registering-your-settings-in-mtaandao-4-7/'
						);
					?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.mtaandao.co.ke/core/2016/10/12/customize-changesets-technical-design-decisions/"><?php _e( 'Customize Changesets' ); ?></a></h3>
