<?php
/**
 * Dependencies API: MN_Styles class
 *
 * @since 2.6.0
 *
 * @package Mtaandao
 ...
 * @since 2.6.0
 */
class MN_Styles extends MN_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		/**
		 * Fires when the MN_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MN_Styles &$this MN_Styles instance, passed by reference.
		 */
		do_action_ref_array( 'mn_default_styles', array(&$this) );
	}
	...
	public function do_item( $handle ) {
		...
		if ( 'rtl' === $this->text_direction && isset($obj->extra['rtl']) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in res/class.mn-styles.php */
