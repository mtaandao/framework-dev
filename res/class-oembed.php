 ...
 *
 * @link https://mtaandao.github.io/oEmbed oEmbed Codex Article
...
class MN_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://mtaandao\.tv/.*#i'                             => array( 'https://mtaandao.tv/oembed/',                              true  ),
			...
			'#https?://(www\.)?issuu\.com/.+/docs/.+#i'                => array( 'https://issuu.com/oembed_mn',                               true  ),
	 ...
	 *
	 * The provider is added just-in-time when mn_oembed_add_provider() is called before
