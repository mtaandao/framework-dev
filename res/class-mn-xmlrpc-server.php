...
class mn_xmlrpc_server extends IXR_Server {
	...
	protected function _prepare_taxonomy( $taxonomy, $fields ) {
		 ...
		 * @param MN_Taxonomy $taxonomy  Taxonomy object.
		 * @param array       $fields    The subset of taxonomy fields to return.
		 */
	...
	public function mn_newComment($args) {
		...
		$comment_ID = mn_new_comment( $comment, true );
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', 'Mtaandao/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) );
