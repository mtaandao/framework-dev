...
?>
	<div id="sidebar" role="complementary">
		...
		<ul role="navigation">
			<?php mn_list_pages('title_li=<h2>' . __('Pages') . '</h2>' ); ?>

			<li><h2><?php _e('Archives'); ?></h2>
				<ul>
				<?php mn_get_archives(array('type' => 'monthly')); ?>
				</ul>
			</li>

			<?php mn_list_categories(array('show_count' => 1, 'title_li' => '<h2>' . __('Categories') . '</h2>')); ?>
		</ul>
		<ul>
			<?php if ( is_home() || is_page() ) { /* If this is the frontpage */ ?>
				<?php mn_list_bookmarks(); ?>
