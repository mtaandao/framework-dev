...
?>
<div class="mn-embed">
	<p class="mn-embed-heading"><?php _e( 'Oops! That embed can&#8217;t be found.' ); ?></p>

	<div class="mn-embed-excerpt">
		<p>
			<?php
			printf(
	...
	<?php
	/** This filter is documented in res/theme-compat/embed-content.php */
