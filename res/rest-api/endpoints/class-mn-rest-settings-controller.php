<?php
/**
 * REST API: MN_REST_Settings_Controller class
 *
 * @package Mtaandao
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MN_REST_Settings_Controller extends MN_REST_Controller {
	 ...
	 *
	 * @param MN_REST_Request $request Full details about the request.
	 * @return array|MN_Error Array on success, or MN_Error object on failure.
	 */
	 ...
	 *
	 * @param MN_REST_Request $request Full details about the request.
	 * @return array|MN_Error Array on success, or error object on failure.
	 */
	 ...
	 * @param  MN_REST_Request $request The request object.
	 * @param  string          $param   The parameter name.
	 * @return mixed|MN_Error
	 */
