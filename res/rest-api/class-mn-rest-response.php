<?php
/**
 * REST API: MN_REST_Response class
 *
 * @package Mtaandao
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class MN_REST_Response extends MN_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = mn_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a MN_Error object from the response.
	 *
	 * @since 4.4.0
	 * @access public
	 *
	 * @return MN_Error|null MN_Error or null on not an errored response.
	 */
