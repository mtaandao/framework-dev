...
class MN_REST_Request implements ArrayAccess {
	 ...
	 * @access protected
	 * @return true|MN_Error True if the JSON data was passed or no JSON data was provided, MN_Error if invalid JSON was passed.
	 */
	protected function parse_json_params() {
		...
		if ( null === $params && ( ! function_exists( 'json_last_error' ) || JSON_ERROR_NONE !== json_last_error() ) ) {
			...
			return new MN_Error( 'rest_invalid_json', __( 'Invalid JSON body passed.' ), $error_data );
		}
	 ...
	 * @access public
	 *
	 * @return true|MN_Error True if parameters were sanitized, MN_Error if an error occurred during sanitization.
	 */
	public function sanitize_params() {
		...
		foreach ( $order as $type ) {
			...
			foreach ( $this->params[ $type ] as $key => $value ) {
				...
				if ( is_mn_error( $sanitized_value ) ) {
