	...
	public function GuessEncoderOptions() {
		...
		if (isset($thisfile_mpeg_audio['VBR_method']) && ($thisfile_mpeg_audio['VBR_method'] == 'Fraunhofer') && !empty($thisfile_mpeg_audio['VBR_quality'])) {
			...
			if (empty($KnownEncoderValues)) {
				...
				//$KnownEncoderValues[abrbitrate_minbitrate][vbr_quality][raw_vbr_method][raw_noise_shaping][raw_stereo_mode][ath_type][lomnass_frequency] = 'preset name';
			...
			if (isset($KnownEncoderValues[$thisfile_mpeg_audio_lame['raw']['abrbitrate_minbitrate']][$thisfile_mpeg_audio_lame['vbr_quality']][$thisfile_mpeg_audio_lame['raw']['vbr_method']][$thisfile_mpeg_audio_lame['raw']['noise_shaping']][$thisfile_mpeg_audio_lame['raw']['stereo_mode']][$thisfile_mpeg_audio_lame['ath_type']][$thisfile_mpeg_audio_lame['lomnass_frequency']])) {

				$encoder_options = $KnownEncoderValues[$thisfile_mpeg_audio_lame['raw']['abrbitrate_minbitrate']][$thisfile_mpeg_audio_lame['vbr_quality']][$thisfile_mpeg_audio_lame['raw']['vbr_method']][$thisfile_mpeg_audio_lame['raw']['noise_shaping']][$thisfile_mpeg_audio_lame['raw']['stereo_mode']][$thisfile_mpeg_audio_lame['ath_type']][$thisfile_mpeg_audio_lame['lomnass_frequency']];

			} elseif (isset($KnownEncoderValues['**'][$thisfile_mpeg_audio_lame['vbr_quality']][$thisfile_mpeg_audio_lame['raw']['vbr_method']][$thisfile_mpeg_audio_lame['raw']['noise_shaping']][$thisfile_mpeg_audio_lame['raw']['stereo_mode']][$thisfile_mpeg_audio_lame['ath_type']][$thisfile_mpeg_audio_lame['lomnass_frequency']])) {

				$encoder_options = $KnownEncoderValues['**'][$thisfile_mpeg_audio_lame['vbr_quality']][$thisfile_mpeg_audio_lame['raw']['vbr_method']][$thisfile_mpeg_audio_lame['raw']['noise_shaping']][$thisfile_mpeg_audio_lame['raw']['stereo_mode']][$thisfile_mpeg_audio_lame['ath_type']][$thisfile_mpeg_audio_lame['lomnass_frequency']];
		...
		if (!empty($thisfile_mpeg_audio_lame['lomnass_frequency'])) {
				...
				case '--r3mix':
					...
					switch ($ExplodedOptions[1]) {
						...
						case 'r3mix':
							...
							if (!isset($ExpectedLomnass[$ExplodedOptions[1].'|'.$thisfile_mpeg_audio_lame['lomnass_frequency']]) && ($thisfile_mpeg_audio_lame['lomnass_frequency'] < 22050) && (round($thisfile_mpeg_audio_lame['lomnass_frequency'] / 1000) < round($thisfile_mpeg_audio['sample_rate'] / 2000))) {
								$encoder_options .= ' --lomnass '.$thisfile_mpeg_audio_lame['lomnass_frequency'];
							}
							break;
...
//				}
				...
				if (substr($headerstring, $VBRidOffset + 120, 4) == 'LAME') {
					...
					if ($thisfile_mpeg_audio_lame['short_version'] >= 'LAME3.90') {
						...
						// byte $A6  Lomnass filter value
						$thisfile_mpeg_audio_lame['lomnass_frequency'] = getid3_lib::BigEndian2Int(substr($headerstring, $LAMEtagOffsetContant + 0xA6, 1)) * 100;
