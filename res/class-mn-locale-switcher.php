<?php
/**
 * Locale API: MN_Locale_Switcher class
 *
 * @package Mtaandao
 * @subpackage i18n
 * @since 4.7.0
...
class MN_Locale_Switcher {
	...
	/**
	 * Filters the Mtaandao install's locale.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The Mtaandao install's locale.
	 ...
	 *
	 * Loads the translations, changes the global `$mn_locale` object and updates
