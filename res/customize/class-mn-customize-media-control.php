<?php
/**
 * Customize API: MN_Customize_Media_Control class
 *
 * @package Mtaandao
 ...
 */
class MN_Customize_Media_Control extends MN_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @since 4.1.0
	 * @since 4.2.0 Moved from MN_Customize_Upload_Control.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( ! ( $this instanceof MN_Customize_Image_Control ) ) {
			$this->button_labels = mn_parse_args( $this->button_labels, array(
	...
	public function to_json() {
		...
		if ( is_object( $this->setting ) ) {
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = mn_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 4.2.0 Moved from MN_Customize_Upload_Control.
	 *
	 * @see MN_Customize_Media_Control::content_template()
	 */
			...
			<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
				<div class="thumbnail thumbnail-{{ data.attachment.type }}">
					...
					<# } else if ( 'video' === data.attachment.type ) { #>
						<div class="mn-media-wrapper mn-video">
