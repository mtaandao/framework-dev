<?php
/**
 * Customize API: MN_Customize_Partial class
 *
 * @package Mtaandao
 ...
 * This class is analogous of MN_Customize_Control.
 *
 * @since 4.5.0
 */
class MN_Customize_Partial {
	 ...
	 * @since 4.5.0
	 * @access public
	 * @see MN_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *                 MN_Customize_Partial. The callback can either echo the
	 ...
	 * @access public
	 *
	 * @param MN_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 * }
	 */
	public function __construct( MN_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param MN_Customize_Partial $partial           MN_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking MN_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( MN_Customize_Partial $partial, $context = array() ) {
