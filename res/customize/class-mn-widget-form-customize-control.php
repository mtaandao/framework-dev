<?php
/**
 * Customize API: MN_Widget_Form_Customize_Control class
 *
 * @package Mtaandao
 ...
 */
class MN_Widget_Form_Customize_Control extends MN_Customize_Control {
	...
	public function to_json() {
		...
		$widget = $mn_registered_widgets[ $this->widget_id ];
