<?php
/**
 * Customize API: MN_Customize_Site_Icon_Control class
 *
 * @package Mtaandao
 ...
 * @since 4.3.0
 *
 * @see MN_Customize_Cropped_Image_Control
 */
class MN_Customize_Site_Icon_Control extends MN_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		add_action( 'customize_controls_print_styles', 'mn_site_icon', 99 );
	}
