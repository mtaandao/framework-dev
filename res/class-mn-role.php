...
class MN_Role {
	...
	public function add_cap( $cap, $grant = true ) {
		...
		mn_roles()->add_cap( $this->name, $cap, $grant );
	}

	/**
	 * Removes a capability from a role.
	 *
	 * This is a container for MN_Roles::remove_cap() to remove the
	 * capability from the role. That is to say, that MN_Roles::remove_cap()
	...
	public function remove_cap( $cap ) {
		...
		mn_roles()->remove_cap( $this->name, $cap );
	}
