...
(function ($) {
	// Create the Mtaandao Backbone namespace.
	mn.Backbone = {};


	// mn.Backbone.Subviews
	// --------------------
	//
	// A subview manager.
	mn.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	mn.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( mn.Backbone.Subviews.prototype, {
		...
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || mn.Backbone.Subviews,
	...
	//
	// The base view class.
	mn.Backbone.View = Backbone.View.extend({
		// The constructor for the `Views` manager.
		Subviews: mn.Backbone.Subviews,
