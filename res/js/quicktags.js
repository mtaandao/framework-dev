/* global adminpage, mnActiveEditor, quicktagsL10n, mnLink, prompt */
/*
 * Quicktags
 *
 * This is the HTML editor in Mtaandao. It can be attached to any textarea and will
...
(function(){
	...
	qt = QTags = function(settings) {
		...
		wrap = document.getElementById( 'mn-' + id + '-wrap' );
	 ...
	 * use add_action( 'admin_print_footer_scripts', 'output_my_js', 100 ) or add_action( 'mn_footer', 'output_my_js', 100 )
	 *
	...
	qt.insertContent = function(content) {
		var sel, startPos, endPos, scrollTop, text, canvas = document.getElementById(mnActiveEditor);
	...
	qt.Button.prototype.html = function(idPrefix) {
		var active, on, mn,
			...
			dfw = ( mn = window.mn ) && mn.editor && mn.editor.dfw;
	...
	qt.DFWButton.prototype.callback = function() {
		...
		if ( ! ( mn = window.mn ) || ! mn.editor || ! mn.editor.dfw ) {
			return;
		}

		window.mn.editor.dfw.toggle();
	};
