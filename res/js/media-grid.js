...
/**
 * mn.media.controller.EditAttachmentMetadata
 *
...
EditAttachmentMetadata = mn.media.controller.State.extend({
	defaults: {
		id:      'edit-attachment',
...
/**
 * mn.media.view.MediaFrame.Manage.Router
 *
...
/**
 * mn.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @class
 * @augments mn.media.view.Attachment.Details
 * @augments mn.media.view.Attachment
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
var Details = mn.media.view.Attachment.Details,
	TwoColumn;

TwoColumn = Details.extend({
	template: mn.template( 'attachment-details-two-column' ),
	...
	render: function() {
		...
		mn.media.mixin.removeAllPlayers();
		this.$( 'audio, video' ).each( function (i, elem) {
			var el = mn.media.view.MediaDetails.prepareSrc( elem );
			new window.MediaElementPlayer( el, mn.media.mixin.mejsSettings );
		} );
	}
});
...
/**
 * mn.media.view.DeleteSelectedPermanentlyButton
 *
 * When MEDIA_TRASH is true, a button that handles bulk Delete Permanently logic
 *
 * @class
 * @augments mn.media.view.DeleteSelectedButton
 * @augments mn.media.view.Button
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
var Button = mn.media.view.Button,
	DeleteSelected = mn.media.view.DeleteSelectedButton,
...
/**
 * mn.media.view.DeleteSelectedButton
 *
...
DeleteSelected = Button.extend({
	...
	filterChange: function( model ) {
		...
		} else if ( mn.media.view.settings.mediaTrash ) {
...
/**
 * mn.media.view.SelectModeToggleButton
 *
 * @class
 * @augments mn.media.view.Button
 * @augments mn.media.View
...
/**
 * mn.media.view.EditImage.Details
 *
 * @class
 * @augments mn.media.view.EditImage
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
var View = mn.media.View,
	EditImage = mn.media.view.EditImage,
	Details;
...
/**
 * mn.media.view.MediaFrame.EditAttachments
 *
...
var Frame = mn.media.view.Frame,
	MediaFrame = mn.media.view.MediaFrame,
...
EditAttachments = MediaFrame.extend({
	...
	template:  mn.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new mn.media.controller.EditAttachmentMetadata( { model: this.model } )
		]);
	},
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new mn.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new mn.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new mn.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new mn.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
/**
 * mn.media.view.MediaFrame.Manage
 *
...
Manage = MediaFrame.extend({
	...
	initialize: function() {
		...
		this.gridRouter = new mn.media.view.MediaFrame.Manage.Router();
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new mn.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			Backbone.history.start( {
				root: window._mnMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
