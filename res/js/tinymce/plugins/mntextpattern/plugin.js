 ...
 * The setting name is `mntextpattern` and the value is an object containing override arrays for each
 * patterns group. There are three groups: "space", "enter", and "inline". Example (PHP):
 *
 * add_filter( 'tiny_mce_before_init', 'my_mce_init_mntextpattern' );
 * function my_mce_init_mntextpattern( $init ) {
 *   $init['mntextpattern'] = mn_json_encode( array(
 *      'inline' => array(
...
( function( tinymce, setTimeout ) {
	...
	tinymce.PluginManager.add( 'mntextpattern', function( editor ) {
		...
		var settings = editor.settings.mntextpattern || {};
