...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function onSubmitForm() {
			...
			function waitLoad(imgElm) {
				...
				imgElm.onload = function() {
					if (!data.width && !data.height && imageDimensions) {
						...
						//MN
						editor.fire( 'mnNewImageRefresh', { node: imgElm } );
					}
			...
			var mncaption = data.mncaption; // MN
			...
			editor.undoManager.transact(function() {
				// MN
				var eventData = { node: imgElm, data: data, mncaption: mncaption };

				editor.fire( 'mnImageFormSubmit', { imgData: eventData } );
		...
		if (imgElm) {
			...
			// MN
			editor.fire( 'mnLoadImageData', { imgData: { data: data, node: imgElm } } );
		}
		...
		// MN
		editor.fire( 'mnLoadImageForm', { data: generalFormItems } );
