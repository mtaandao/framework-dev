...
tinymce.PluginManager.add( 'mtaandao', function( editor ) {
	...
	editor.addCommand( 'MN_Help', function() {
		var access = tinymce.Env.mac ? __( 'Ctrl + Alt + letter:' ) : __( 'Shift + Alt + letter:' ),
			...
			i1 = 0,
			i2 = 0,
			labels = editor.settings.mn_shortcut_labels,
	...
	editor.on( 'init', function() {
		...
		if ( editor.settings.mn_shortcut_labels && editor.theme.panel ) {
			var labels = {};
			...
			each( editor.settings.mn_shortcut_labels, function( value, name ) {
