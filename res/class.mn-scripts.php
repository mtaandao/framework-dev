<?php
/**
 * Dependencies API: MN_Scripts class
 *
 * @since 2.6.0
 *
 * @package Mtaandao
 ...
 *
 * @package Mtaandao
 * @uses MN_Dependencies
 * @since 2.1.0
 */
class MN_Scripts extends MN_Dependencies {
	/**
	...
	public function init() {
		/**
		 * Fires when the MN_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MN_Scripts &$this MN_Scripts instance, passed by reference.
		 */
		do_action_ref_array( 'mn_default_scripts', array(&$this) );
	}
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . mn_json_encode( $l10n ) . ';';
