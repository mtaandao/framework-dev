		...
		if ( self::$this_tinymce ) {
			...
			if ( empty( self::$first_init ) ) {
				...
				self::$first_init = array(
					...
					'mn_shortcut_labels' => mn_json_encode( $shortcut_labels ),
				);
			...
			if ( $set['teeny'] ) {
				...
				$mce_buttons = array( 'formatselect', 'bold', 'italic', 'bullist', 'numlist', 'blockquote', 'alignleft', 'aligncenter', 'alignright', 'link', 'unlink', 'mn_more', 'spellchecker' );
