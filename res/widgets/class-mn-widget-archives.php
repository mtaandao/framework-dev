<?php
/**
 * Widget API: MN_Widget_Archives class
 *
 * @package Mtaandao
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MN_Widget
 */
class MN_Widget_Archives extends MN_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
			...
			<?php mn_get_archives( $dropdown_args ); ?>
		 ...
		 */
		mn_get_archives( apply_filters( 'widget_archives_args', array(
			'type'            => 'monthly',
			'show_post_count' => $c
		) ) );
		?>
	 ...
	 *                            MN_Widget_Archives::form().
	 * @param array $old_instance Old settings for this instance.
	 * @return array Updated settings to save.
	 */
	public function update( $new_instance, $old_instance ) {
		$instance = $old_instance;
		$new_instance = mn_parse_args( (array) $new_instance, array( 'title' => '', 'count' => 0, 'dropdown' => '') );
	...
	public function form( $instance ) {
		$instance = mn_parse_args( (array) $instance, array( 'title' => '', 'count' => 0, 'dropdown' => '') );
