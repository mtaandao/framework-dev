<?php
/**
 * Widget API: MN_Widget_Text class
 *
 * @package Mtaandao
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MN_Widget
 */
class MN_Widget_Text extends MN_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 * @param MN_Widget_Text $this        Current Text widget instance.
		 */
		...
		if ( ! empty( $title ) ) {
			...
			<div class="textwidget"><?php echo !empty( $instance['filter'] ) ? mnautop( $text ) : $text; ?></div>
		<?php
