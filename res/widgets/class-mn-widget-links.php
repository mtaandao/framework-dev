<?php
/**
 * Widget API: MN_Widget_Links class
 *
 * @package Mtaandao
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MN_Widget
 */
class MN_Widget_Links extends MN_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		mn_list_bookmarks( apply_filters( 'widget_links_args', $widget_links_args, $instance ) );
	}
	...
	public function form( $instance ) {
		...
		//Defaults
		$instance = mn_parse_args( (array) $instance, array( 'images' => true, 'name' => true, 'description' => false, 'rating' => false, 'category' => false, 'orderby' => 'name', 'limit' => -1 ) );
