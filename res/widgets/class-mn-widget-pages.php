<?php
/**
 * Widget API: MN_Widget_Pages class
 *
 * @package Mtaandao
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MN_Widget
 */
class MN_Widget_Pages extends MN_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$out = mn_list_pages( apply_filters( 'widget_pages_args', array(
			'title_li'    => '',
			'echo'        => 0,
			'sort_column' => $sortby,
			'exclude'     => $exclude
	...
	public function form( $instance ) {
		//Defaults
		$instance = mn_parse_args( (array) $instance, array( 'sortby' => 'post_title', 'title' => '', 'exclude' => '') );
		?>
		<p>
