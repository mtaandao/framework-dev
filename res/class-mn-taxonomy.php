<?php
/**
 * Taxonomy API: MN_Taxonomy class
 *
 * @package Mtaandao
 * @subpackage Taxonomy
 * @since 4.7.0
...
final class MN_Taxonomy {
	...
	public function add_hooks() {
		add_filter( 'mn_ajax_add-' . $this->name, '_mn_ajax_add_hierarchical_term' );
	}
	...
	public function remove_hooks() {
		remove_filter( 'mn_ajax_add-' . $this->name, '_mn_ajax_add_hierarchical_term' );
	}
}
