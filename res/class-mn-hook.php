 ...
 * @see ArrayAccess
 */
final class MN_Hook implements Iterator, ArrayAccess {
	...
	public function remove_filter( $tag, $function_to_remove, $priority ) {
		$function_key = _mn_filter_build_unique_id( $tag, $function_to_remove, $priority );
	...
	public function has_filter( $tag = '', $function_to_check = false ) {
		...
		$function_key = _mn_filter_build_unique_id( $tag, $function_to_check, false );
		if ( ! $function_key ) {
			return false;
		}
	...
	/**
	 * Normalizes filters set up before Mtaandao has initialized to MN_Hook objects.
	 *
	 * @since 4.7.0
	 * @access public
	 * @static
	 ...
	 * @return MN_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var MN_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $tag => $callback_groups ) {
			if ( is_object( $callback_groups ) && $callback_groups instanceof MN_Hook ) {
