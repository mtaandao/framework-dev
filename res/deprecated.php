 ...
 *
 * @link https://mtaandao.github.io/The_Loop
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 */
 ...
 * @see get_terms()
 *
 * @link https://mtaandao.github.io/Function_Reference/get_all_category_ids
 *
 ...
 */
function admin_bar_dashboard_view_site_menu( $admin_bar ) {
	_deprecated_function( __FUNCTION__, '3.3.0' );
	...
	if ( 0 != $user_id ) {
		if ( is_admin() )
			$admin_bar->add_menu( array( 'id' => 'view-site', 'title' => __( 'Visit Site' ), 'href' => home_url() ) );
		elseif ( is_multisite() )
			$admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => get_dashboard_url( $user_id ) ) );
		else
			$admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => admin_url() ) );
	}
}
...
function _usort_terms_by_ID( $a, $b ) {
	_deprecated_function( __FUNCTION__, '4.7.0', 'mn_list_sort' );
